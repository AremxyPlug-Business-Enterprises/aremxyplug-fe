      ...
      <div className=" w-[360px] h-[1405px] lg:w-full md:w-full  bg-white">
        <div className="h-[64.71px] lg:h-[196px] md:h-[112.29px] w-[312px]  md:rounded-[11.46px] lg:rounded-[20px] mx-auto md:w-full lg:w-full gap-6 px-[16.51px] md:px-[28.65px]  pl-[50px] pr-[60.79px] py-[22px] ml-[5px] bg-gradient-to-r from-yellow-300 to-rose-400 rounded-[6px] md:gap-[20px] md:items-center  justify-start lg:items-start flex">
          <div className="py-[11px] md:ml-[40px] md:py-[16.61px] lg:py-[29px] lg:align-middle flex flex-col md:gap-[8.59px] gap-1 lg:gap-1.5">
            <div className="lg:w-[481px] md:w-[275.57px] lg:ml-[0px] ml-[-35px] md:mt-[10px] mt-[-23px] lg:mt-[0px] w-[160.85px] text-black lg:text-2xl md:text-sm text-[8.08px] font-semibold  uppercase">
          ...
          <img
            className="lg:w-[170.21px] mt-[-15px] md:ml-[90px] md:mt-[10px] lg:mt-[0px] ml-[8px] lg:ml-[150px] md:w-[91.21px] w-[53.24px] lg:h-[150px] md:h-[85.94px] h-[50.16px] "
            src={cash}
            alt=""
          />
        </div>
        <div className=" lg:top-[860px] top-[410px] md:top-[630px] absolute mt-[-30px]  lg:justify-start lg:items-center gap-[5px]  inline-flex">
        ...
        <div className="  lg:top-[736px] top-[287.82px] mt-[25px] w-[312px] lg:w-full md:w-full md:gap-[51.85px] lg:justify-between lg:items-center lg:gap-[90.50px] gap-2.5 inline-flex">
          ...
          <div className="lg:px-10 px-[5px] lg:py-[15px] h-[52px] lg:h-[78px] w-[82px] md:w-full lg:w-[200px] md:px-[22px] md:py-[8.9px] py-[4.92px] md:gap-[2.86px] md:rounded  bg-emerald-100 lg:rounded-md rounded-sm flex-col lg:justify-center lg:items-center lg:gap-[5px] gap-[1.64px] inline-flex">
            <div className="lg:justify-start lg:items-center md:gap-[2.86px] lg:gap-[5px] inline-flex">
              <div className="text-black lg:text-base text-[10px] md:text-[9.17px] font-medium ">
                Total Inflows
              </div>
            ...
            <div className="lg:justify-start lg:items-start lg:gap-[5px] gap-[1.64px] md:gap-[2.86px] inline-flex">
              <div className="text-black lg:text-base text-[10px] md:text-[9.17px] font-semibold  md:leading-[11px] lg:leading-tight leading-3">
                ₦
              </div>
              <div className="text-black lg:text-base text-[10px] md:text-[9.17px]   font-medium  md:leading-[11px] lg:leading-tight leading-3">
                96,001,55
              </div>
            </div>
          </div>
          <div className="lg:w-[200px] w-[99px] lg:h-[78px] lg:px-10 px-[5px] lg:py-[15px] h-[52px]  py-[4.92px] bg-indigo-300 bg-opacity-20 md:w-full md:px-[22px] md:py-[8.9px] md:gap-[2.86px] lg:rounded-md rounded-sm flex-col lg:justify-center lg:items-center lg:gap-[5px]gap-[1.64px]  inline-flex">
            <div className="lg:justify-start lg:items-center lg:gap-[5px] gap-[1.64px] md:gap-[2.86px] inline-flex">
              <div className="text-black lg:whitespace-nowrap lg:text-base md:whitespace-nowrap  text-[10px] md:text-[9.17pxpx] font-medium ">
                Total Transactions
              </div>
            ...
            <div className="lg:justify-start lg:items-start lg:gap-[5px] md:gap-[2.86px] gap-[1.64px] inline-flex">
              <div className="text-black lg:text-base text-[8px] md:text-[9.17px] font-medium lg:leading-tight leading-3">
                10,000
              </div>
            </div>
          </div>
          <div className="lg:w-[200px] lg:px-10 lg:h-[78px] lg:py-[15px] w-[82px] h-[52px]  px-[px] py-[4.92px] md:w-full md:px-[22px] md:py-[8.9px]  bg-red-200 lg:rounded-md rounded-sm flex-col lg:justify-center lg:items-center lg:gap-[5px] gap-[1.64px] inline-flex">
            <div className="lg:justify-start lg:items-center lg:gap-[5px] gap-[1.64px] md:gap-[2.86px] inline-flex">
              <div className="text-black lg:text-base text-[10px] lg:whitespace-nowrap md:text-[9.17px] font-medium ">
                Total Outflows
              </div>
            ...
            <div className="lg:justify-start lg:items-start lg:gap-[5px] gap-[1.64px] md:gap-[2.86px] inline-flex">
              <div className="text-black lg:text-base text-[10px] md:text-[9.17px] font-semibold font-['Poppins'] md:leading-[11px] lg:leading-tight leading-3">
                ₦
              </div>
              <div className="text-black lg:text-base text-[10px] md:text-[9.17px]  font-medium  lg:leading-tight md:leading-[11px] leading-3">
                96,001,55
              </div>
            </div>
          </div>
          ...
          <div className="items-center flex-row md:justify-between lg:justify-between  justify-around flex">
            <div>
              <div className="flex lg:gap-3 lg:mt-[-15px] gap-1 mt-[0.1px] md:gap-2 flex-row  ">
                ...
                <div className="text-neutral-400 text-[8px] lg:text-base mt-[5px] md:text-xs leading-3 whitespace-nowrap font-medium  lg:leading-tight">
        ...
        <table className=" md:text-[12px] md:block hidden  lg:text-[16px]">
          <thead className="w-[600px]">
            <tr className="bg-[#c3d9ff] lg:h-[47px]">
              ...
              <th className="border-none">Order No</th>
              <th className="border-none">Amount</th>
              <th className="border-none">Date & Time</th>
              <th className="border-none">Status</th>
            </tr>
          </thead>

          <tbody className="lg:text-base md:text-[9.17px] font-medium text-neutral-500 md:leading-3 lg:leading-tight ">
            <tr className="">
              ...
              <td className="flex lg:gap-[20px] md:gap-[10px]  border-none ">
                <p className="gap-[5px] lg:p-2.5 md:px-[5.73px] md:py-[2.86px] md:rounded-[2.86px] md:text-[9.17px] lg:text-base md:leading-3 lg:leading-tight  font-medium  items-center lg:h-[31px] md:h-[18px] text-white bg-green-300 lg:w-[120px] md:w-[60px ] lg:rounded-[5px]">
                  {" "}
                  Successful 
                </p>
                <img
                  className="w-[10px] h-[10px] md:w-[10px] md:h-[10px] lg:w-[15px] lg:h-[15px] border-none"
                  src={arrows}
                  alt="/"
                />
              </td>
            ...
            <tr>
              ...
              <td className="flex lg:gap-[20px] md:gap-[10px] border-none">
                <p className="gap-[5px] lg:p-2.5 md:px-[5.73px] md:py-[2.86px] md:rounded-[2.86px] md:text-[9.17px] lg:text-base md:leading-3 lg:leading-tight  font-medium  items-center lg:h-[31px] md:h-[18px] text-white bg-red-300 lg:w-[120px] md:w-[60px ] lg:rounded-[5px]">
                  {" "}
                  Pending
                </p>
                <img
            ...
            <tr>
              ...
              <td className="flex lg:gap-[20px] md:gap-[10px] border-none">
                <p className="gap-[5px] lg:p-2.5 md:px-[5.73px] md:py-[2.86px] md:rounded-[2.86px] md:text-[9.17px] lg:text-base md:leading-3 lg:leading-tight  font-medium  items-center lg:h-[31px] md:h-[18px] text-white bg-amber-200 lg:w-[120px] md:w-[60px ] lg:rounded-[5px]">
                  {" "}
                 Pending 
                </p>
                <img
        ...
        <div className="flex lg:h-10 lg:w-[100%] flex-col lg:gap-5 md:gap-3 md:mt-[10px]  items-center justify-center lg:mt-[30px]">
              ...
              <div className="justify-start items-center hidden md:block lg:w-[100%] lg:ml-[750px]  lg:gap-[26px] md:w-[108.08px] md:h-[11.73px] md:gap-[14.90px] lg:flex">
        ...
        {/* <div className="hidden md:overflow-scroll md:block lg:block  shadow-black md:w-[100%] shadow-lg lg:w-full lg:mt-[-50px] "> */}
          {/* <table className={`${toggleSideBar ? "md:w-[50%]" : "md:w-[50%]"} lg:w-full  justify-start  md:h-[517.15px] lg:h-[892px] items-start bg-white shadow `}> */}
            {/* <div className=" "> */}
              {/* {" "} */}
              {/* <thead class={`${toggleSideBar ? "md:w-[80%]" : "md:w-[100%]"} flex flex-row lg:w-full   md:items-start  bg-indigo-200`}> */}
                {/*  */}
              {/*  */}
                  {/* <tr className=" flex md:justify-between border-none md:w-[100%] "> */}
                    {/* <div> */}
                      {/* <th  className="lg:px-6 lg:py-3 md:px-3 md:py-2 md:w-[100%] md:text-[9.17px]  md:leading-3 lg:w-[202px] border-none  text-black lg:text-base font-semibold  lg:leading-tight"> */}
                        {/* Products */}
                      {/* </th> */}
                    {/* </div> */}
                    {/* <div> */}
                    ...
                    {/* </div> */}
                    {/* <div> */}
                      {/* <th className="lg:px-6 lg:py-3 md:px-3 md:py-2 md:w-[100%] md:text-[9.17px]  md:leading-3 lg:w-[202px] text-black border-none lg:text-base font-semibold  lg:leading-tight"> */}
                        {/* Date & Time */}
                      {/* </th> */}
                    {/* </div> */}
                    {/* <div> */}
                      {/* <th className="lg:px-6 lg:py-3 md:px-3 md:py-2 md:w-[100%] md:text-[9.17px]  md:leading-3 lg:w-[202px] text-black lg:text-base border-none  font-semibold lg:leading-tight"> */}
                        {/* Status */}
                      {/* </th> */}
                    {/* </div> */}
                  {/* </tr> */}
            ...
            {/* <tbody className="lg:h-[708px] items-start justify-start flex flex-col bg-white "> */}
              {/* <tr className="justify-start items-start md:gap-[300px"> */}
                ...
                {/* <td className="lg:px-6 lg:py-4 md:w-[205px] md:text-[9.17px] md:leading-3 lg:w-[205px] border-none  text-neutral-500 lg:text-base font-medium  lg:leading-tight"> */}
                  {/* 0000000 */}
                {/* </td> */}
                {/* <td className="lg:px-6 lg:py-4 lg:w-[205px] md:w-[205px] md:text-[9.17px] md:leading-3 border-none text-neutral-500 lg:text-base font-medium  lg:leading-tight"> */}
                  {/* ₦1,000.00 */}
                {/* </td> */}
                {/* <td className="lg:px-6 lg:py-4 border-none whitespace-nowrap md:w-[205px] md:text-[9.17px] md:leading-3 lg:w-[205px] text-neutral-500 lg:text-base font-medium  lg:leading-tight "> */}
                  {/* May 21st, 2023, */}
                  {/* <br /> */}
                  {/* 07:21:00pm */}
                {/* </td> */}
                {/* <td className="border-none"> */}
                  {/* {" "} */}
                  {/* <div class=" bg-white gap-5 flex-row justify-start items-center flex"> */}
                    {/* {" "} */}
                    {/* <div className="md:w-[60.46px] md:h-[17.73px] md:px-[5.73px] md:py-[2.86px] md:rounded-[2.86px] md:gap-[5.73px] md:text-[9.17px] md:leading-3 whitespace-nowrap text-white border-b lg:px-2.5 lg:py-[5px]  lg:h-[31px] lg:w-[120px]  bg-green-300 lg:rounded-[5px] lg:text-base font-medium  flex justify-center items-center lg:gap-2.5 lg:leading-tight "> */}
                      {/* Successful */}
                    {/* </div> */}
                    {/* <div className="lg:w-[15px] lg:h-[15px] md:w-[8.59px] md:h-[8.59px] justify-center items-center flex"> */}
                      {/* <img src={arrows} alt="" /> */}
                    {/* </div> */}
                  {/* </div> */}
                {/* </td> */}
...
{/*  */}
              {/* <tr className="justify-start items-start md:gap-[300px"> */}
                {/* <td className="whitespace-nowrap border-none md:w-[205px] md:text-[9.17px] md:leading-3  lg:w-[205px] text-black px-6 py-4 lg:text-base font-medium lg:leading-tight"> */}
                  {/* Withdrawal */}
                {/* </td> */}
                {/* <td className=" text-neutral-500 border-none md:w-[205px] md:text-[9.17px] md:leading-3 lg:w-[205px] px-6 py-4 lg:text-base font-medium md:whitespace-nowrap lg:leading-tight"> */}
                  {/* From USD Wallet to <br /> Bank */}
                {/* </td> */}
                {/* <td className="text-neutral-500 lg:w-[205px] md:text-[9.17px] md:w-[205px] md:leading-3 border-none lg:text-base px-6 py-4  font-medium lg:leading-tight"> */}
                  {/* 0000000 */}
                {/* </td> */}
                {/* <td className="text-neutral-500 lg:w-[205px] border-none md:w-[205px] md:text-[9.17px] md:leading-3 px-6 py-4 lg:text-base font-medium lg:leading-tight"> */}
                  {/* ₦25,000.00 */}
                {/* </td> */}
                {/* <td className="md:w-[205px] md:text-[9.17px] md:leading-3 px-6 py-4 lg:w-[205px] text-neutral-500 border-none lg:text-base font-medium lg:leading-tight"> */}
                  {/* May 21st, 2023, */}
                  {/* <br /> */}
                  {/* 07:21:00pm */}
                {/* </td> */}
                {/* <td className="border-none"> */}
                  {/* <div className=" bg-white gap-5 flex-row justify-start items-center flex"> */}
                    {/* <div className="md:w-[60.46px] md:h-[17.73px] md:px-[5.73px] md:py-[2.86px] md:rounded-[2.86px] md:gap-[5.73px] md:text-[9.17px] md:leading-3 text-white whitespace-nowrap lg:text-base font-medium  lg:px-2.5 lg:py-[5px]  lg:h-[31px] lg:w-[120px] bg-green-300 lg:rounded-[5px] justify-center items-center lg:gap-2.5 flex lg:leading-tight"> */}
                      {/* Successful */}
                    {/* </div> */}
                    {/* <div className="lg:w-[15px] lg:h-[15px] md:w-[8.59px] md:h-[8.59px] justify-center items-center flex "> */}
                      {/* <img src={arrows2} alt="" /> */}
...
{/*  */}
              {/* <tr className="justify-start items-start md:gap-[300px"> */}
                {/* <td className="md:w-[205px] md:text-[9.17px] md:leading-3 lg:w-[205px] border-none  text-black lg:text-base px-6 py-4 font-medium  lg:leading-tight"> */}
                  {/* Card Payment */}
                {/* </td> */}
                {/* <td className="lg:w-[205px] md:w-[205px] md:text-[9.17px] md:leading-3 border-none text-neutral-500 lg:text-base px-6 py-4 font-medium md:whitespace-nowrap  lg:leading-tight"> */}
                  {/* NGN Wallet Top-up */}
                {/* </td> */}
                {/* <td className="text-neutral-500 md:w-[205px] lg:w-[205px] md:text-[9.17px] md:leading-3 border-none lg:text-base px-6 py-4 font-medium  lg:leading-tight"> */}
                  {/* 0000000 */}
                {/* </td> */}
                {/* <td className="text-neutral-500 lg:w-[205px] md:w-[205px] md:text-[9.17px] md:leading-3 border-none lg:text-base px-6 py-4 font-medium  lg:leading-tight"> */}
                  {/* ₦25,000.00 */}
                {/* </td> */}
                {/* <td className="md:w-[205px] md:text-[9.17px] md:leading-3 text-neutral-500 lg:w-[205px] px-6 py-4 border-none lg:text-base font-medium  lg:leading-tight"> */}
                  {/* May 21st, 2023, */}
                  {/* <br /> */}
                  {/* 07:21:00pm */}
                {/* </td> */}
                {/* <td className="border-none"> */}
                  {/* <div className=" bg-white gap-5 flex-row justify-start items-center flex"> */}
                    {/* <div class="md:w-[60.46px] md:h-[17.73px] md:px-[5.73px] md:py-[2.86px] md:rounded-[2.86px] md:gap-[5.73px] md:text-[9.17px] md:leading-3 text-white whitespace-nowrap lg:text-base font-medium lg:px-2.5 lg:py-[5px]  lg:h-[31px] lg:w-[120px] bg-green-300 lg:rounded-[5px] justify-center items-center lg:gap-2.5 flex lg:leading-tight"> */}
                      {/* Successful */}
                    {/* </div> */}
                    {/* <div className="lg:w-[15px] lg:h-[15px] md:w-[8.59px] md:h-[8.59px] justify-center items-center flex "> */}
                      {/* <img src={arrows3} alt="" /> */}
...
{/*  */}
              {/* <tr className="justify-start items-start md:gap-[300px"> */}
                {/* <td className="md:w-[205px] md:text-[9.17px] md:leading-3 lg:w-[205px] border-none text-black px-6 py-4 lg:text-base font-medium lg:leading-tight"> */}
                  {/* Money Transfer */}
                {/* </td> */}
                {/* <td className="lg:w-[205px] md:w-[205px] md:text-[9.17px] md:leading-3 border-none text-neutral-500 px-6 py-4 lg:text-base font-medium md:whitespace-nowrap  lg:leading-tight"> */}
                  {/* From NGN Wallet to <br /> AremxyPlug */}
                {/* </td> */}
                {/* <td className="text-neutral-500 md:text-[9.17px] md:leading-3 border-none md:w-[205px] lg:text-base lg:w-[205px] px-6 py-4 font-medium  lg:leading-tight"> */}
                  {/* 0000000 */}
                {/* </td> */}
                {/* <td className="text-neutral-500 md:w-[205px] md:text-[9.17px] md:leading-3 border-none lg:text-base font-medium lg:w-[205px] px-6 py-4  lg:leading-tight"> */}
                  {/* ₦25,000.00 */}
                {/* </td> */}
                {/* <td className="md:w-[205px] md:text-[9.17px] md:leading-3 lg:w-[205px] border-none text-neutral-500 px-6 py-4 lg:text-base font-medium  lg:leading-tight"> */}
                  {/* May 21st, 2023, */}
                  {/* <br /> */}
                  {/* 07:21:00pm */}
                {/* </td> */}
...
{/*  */}
              {/* <tr className="justify-start items-start md:gap-[300px"> */}
                {/* <td className="md:w-[205px] md:text-[9.17px] md:leading-3 px-6 py-4 lg:w-[205px] text-black border-none lg:text-base font-medium lg:leading-tight"> */}
                  {/* Money Transfer */}
                {/* </td> */}
                {/* <td className="px-6 py-4 md:w-[205px] md:text-[9.17px] md:leading-3 lg:w-[205px] text-neutral-500 border-none lg:text-base font-medium md:whitespace-nowrap lg:leading-tight"> */}
                  {/* From NGN Wallet to <br /> Bank */}
                {/* </td> */}
                {/* <td className="text-neutral-500 md:w-[205px] px-6 py-4 md:text-[9.17px] md:leading-3 lg:w-[205px] border-none lg:text-base font-medium  lg:leading-tight"> */}
                  {/* 0000000 */}
                {/* </td> */}
                {/* <td className="text-neutral-500 md:w-[205px] md:text-[9.17px] md:leading-3 border-none lg:text-base lg:w-[205px] px-6 py-4 font-medium  lg:leading-tight"> */}
                  {/* ₦50,000.00 */}
                {/* </td> */}
                {/* <td className="md:w-[205px] md:text-[9.17px] md:leading-3 lg:w-[205px] text-neutral-500 px-6 py-4 border-none lg:text-base font-medium  lg:leading-tight"> */}
                  {/* May 21st, 2023, */}
                  {/* <br /> */}
                  {/* 07:21:00pm */}
                {/* </td> */}
                {/* <td className="border-none"> */}
                  {/* <div className=" bg-white gap-5 flex-row lg:justify-start lg:items-center flex"> */}
                    {/* {" "} */}
                    {/* <div className="md:w-[60.46px] md:h-[17.73px] md:px-[5.73px] md:py-[2.86px] md:rounded-[2.86px] md:gap-[5.73px] md:text-[9.17px] md:leading-3 text-white lg:text-base font-medium  lg:leading-tight lg:w-[120px] lg:h-[31px] p-2.5 bg-amber-200 lg:rounded-[5px] justify-center items-center lg:gap-2.5  flex"> */}
                      {/* Pending */}
                    {/* </div> */}
                    {/* <div className="lg:w-[15px] lg:h-[15px] md:w-[8.59px] md:h-[8.59px] justify-center items-center flex "> */}
                      {/* <img src={arrows5} alt="" /> */}
...
{/*  */}
              {/* <tr className="justify-start items-start md:gap-[300px"> */}
                {/* <td className="md:w-[205px] md:text-[9.17px] md:leading-3 lg:w-[205px]  text-black px-6 py-4 border-none lg:text-base font-medium lg:leading-tight"> */}
                  {/* Money Transfer */}
                {/* </td> */}
                {/* <td className="lg:w-[205px] md:w-[205px] md:text-[9.17px] md:leading-3 px-6 py-4 text-neutral-500 border-none  lg:text-base font-medium md:whitespace-nowrap lg:leading-tight"> */}
                  {/* From NGN Wallet to <br /> AremxyPlug */}
                {/* </td> */}
                {/* <td className="text-neutral-500 border-none md:w-[205px]  md:text-[9.17px] md:leading-3 px-6 py-4 lg:w-[205px] lg:text-base font-medium  lg:leading-tight"> */}
                  {/* 0000000 */}
                {/* </td> */}
                {/* <td className="text-neutral-500 border-none md:w-[205px] md:text-[9.17px] md:leading-3 lg:text-base px-6 py-4 lg:w-[205px] font-medium  lg:leading-tight"> */}
                  {/* $60,000.00 */}
                {/* </td> */}
                {/* <td className="md:w-[205px] md:text-[9.17px] md:leading-3 text-neutral-500 border-none lg:text-base px-6 py-4 lg:w-[205px] font-medium  lg:leading-tight"> */}
                  {/* May 21st, 2023, */}
                  {/* <br /> */}
                  {/* 07:21:00pm */}
                {/* </td> */}
{/*  */}
                {/* <td className="border-none"> */}
                  {/* <div className=" bg-white gap-5 flex-row lg:justify-start lg:items-center flex"> */}
                    {/* {" "} */}
                    {/* <div className="md:w-[60.46px] md:h-[17.73px] md:px-[5.73px] md:py-[2.86px] md:rounded-[2.86px] md:gap-[5.73px] md:text-[9.17px] md:leading-3 text-white lg:text-base font-medium lg:leading-tight lg:w-[120px] lg:h-[31px] lg:p-2.5 bg-red-300 lg:rounded-[5px] justify-center items-center lg:gap-2.5  flex"> */}
                      {/* Pending */}
                    {/* </div> */}
                    {/* <div className="lg:w-[15px] lg:h-[15px] md:w-[8.59px] md:h-[8.59px] justify-center items-center flex "> */}
                      {/* <img src={arrows6} alt="" /> */}
...
{/*  */}
              {/* <tr className="justify-start items-start md:gap-[300px"> */}
                {/* <td className="md:w-[205px] md:text-[9.17px] md:leading-3 px-6 py-4 lg:w-[205px] border-none text-black lg:text-base font-medium  lg:leading-tight"> */}
                  {/* International Transfer */}
                {/* </td> */}
                {/* <td className=" md:w-[205px] md:text-[9.17px] md:leading-3 lg:w-[205px] px-6 py-4 text-neutral-500 border-none lg:text-base font-medium md:whitespace-nowrap lg:leading-tight"> */}
                  {/* From USD Wallet to <br /> Bank */}
                {/* </td> */}
                {/* <td className="text-neutral-500 md:text-[9.17px] md:w-[205px] md:leading-3 px-6 py-4 lg:w-[205px] lg:text-base border-none font-medium  lg:leading-tight"> */}
                  {/* 0000000 */}
                {/* </td> */}
                {/* <td className="text-neutral-500 md:w-[205px] md:text-[9.17px] md:leading-3 lg:text-base px-6 py-4 lg:w-[205px] border-none font-medium  lg:leading-tight"> */}
                  {/* ₦10,000.00 */}
                {/* </td> */}
                {/* <td className="md:w-[205px] md:text-[9.17px] md:leading-3 lg:w-[205px] text-neutral-500 lg:text-base px-6 py-4 font-medium border-none  lg:leading-tight"> */}
                  {/* May 21st, 2023, */}
                  {/* <br /> */}
                  {/* 07:21:00pm */}
                {/* </td> */}
{/*  */}
                {/* <td className="border-none"> */}
                  {/* <div className=" bg-white gap-5 flex-row justify-start items-center flex"> */}
                    {/* {" "} */}
                    {/* <div className="md:w-[60.46px] md:h-[17.73px] md:px-[5.73px] md:py-[2.86px] md:rounded-[2.86px] md:gap-[5.73px] md:text-[9.17px] md:leading-3 text-white lg:text-base font-medium lg:leading-tight lg:w-[120px] lg:h-[31px] lg:p-2.5 bg-amber-200 lg:rounded-[5px] justify-center items-center lg:gap-2.5  flex"> */}
                      {/* Pending */}
                    {/* </div> */}
                    {/* <div className="lg:w-[15px] lg:h-[15px] md:w-[8.59px] md:h-[8.59px] justify-center items-center flex "> */}
                      {/* <img src={arrows7} alt="" /> */}
        ...
        <div className="shadow  md:hidden  h-[1000px] mt-[15px] w-[312px] justify-center  border-opacity-20">
          <div className="w-full  h-[868.35px] px-[5px] py-5 bg-white  mt-[120px] flex-col ml-[6px] justify-center items-center gap-[21px] flex">
            <div className="flex-col justify-center items-start gap-11 flex">
              <div className="justify-start items-start gap-[100px] flex">
                <div className="flex-col justify-start items-start gap-[7.65px] flex">
                  <div className="text-neutral-500 text-[8px] font-medium  leading-[10.40px]">
                    Order No : 0000000
                  </div>
                  <div className="text-black text-[8px] font-medium  leading-[10.40px]">
                ...
                <div className="flex-col justify-center  items-start gap-[11.47px] flex">
                  <div className="justify-end items-center gap-0.5 flex-row flex">
                    <div className="text-neutral-500 text-[8px] font-medium whitespace-nowrap  leading-[10.40px]">
                      Status :
                    </div>
                    <div className="px-[4.24px] py-[2.12px] bg-green-300 rounded-sm justify-start items-start gap-[4.24px] flex">
                      <div className="text-white text-[8px] font-medium  leading-[10.40px]">
                        Successful
                      </div>
                    </div>
                  </div>
              ...
              <div className="w-[278px] justify-start items-start gap-[100px] flex">
                ...
                <div className="w-[81px] flex-col justify-center items-start gap-[87px] flex">
                  ...
                  <div class="w-[13.41px] h-[12.06px] relative"></div>
                </div>
              </div>
            </div>
          </div>
          <div className="flex justify-center mt-[20px] lg:hidden md:hidden items-center gap-[30px] flex-col">
            <div className="w-[66px] ml-[20px] h-4 px-1.5 py-[3px] bg-white shadow border border-black border-opacity-30 justify-start items-center gap-[5px] inline-flex">
              <div className="text-neutral-500 text-[8px] font-medium mt-[10px] leading-[10.40px]">
                ---The End---
              </div>
            </div>
