      ...
      {confirmStarTimesPopup &&
        (
         ...
         justify-between font-[500] lg:text-[16px]">
                  ...
                  mx-auto justify-between font-semibold lg:text-[16px]">
         ...
         justify-between font-[500] lg:text-[16px]">
                    ...
                    <span className={`${isDarkMode ? "text-white" : "text-black"}`}>{`${starTimesAmount !== undefined || starTimesAmount !== "" ? starTimesAmount?.toLocaleString("en-NG", {
                      style : "currency",
                      currency : "NGN"
                    }) : "₦"}`}</span>
                  </div>
