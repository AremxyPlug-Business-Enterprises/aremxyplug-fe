        ...
        <div className='flex flex-col justify-between h-full'>
          <div>
            ...
            <div className='  md:mt-9 mt-8 lg:mt-14 flex items-center w-full justify-between gap-[10px] lg:gap-[15px]'>
               {/* ADD MONEY BUTTON */}
              <Link to='/top-up' className='bg-primary text-white rounded-[4px] md:rounded-[12px] flex items-center 
            justify-center py-[10px] w-1/3'>
                ...
                <h2 className="text-white font-[400] md:font-[500] text-[10px] leading-[14.5px] lg:text-[16px]
                md:text-[11px] md:leading-[16.75px] lg:leading-[24px]">Add Money</h2>
              </Link>
              {/* ADD WALLET BUTTON  */}
              <button className='bg-primary text-white  rounded-[4px] md:rounded-[7px] flex items-center 
              justify-center py-[10px] w-1/3 lg:py-[10px]' onClick={() => setCurrencyNotAvailable(true)}>
                <div className='mr-1 w-[11.38px] h-[11.38px] md:w-[19.48px] md:h-[19.48px] lg:w-[34px] lg:h-[34px]'>
                  <img src="./Images/wallet/wallet-add.png" alt="" className='object-cover w-full'/>
                </div>
                <h2 className="text-white text-[10px] leading-[14.5px] lg:text-[16px]
                md:text-[11px] md:leading-[16.75px] lg:leading-[24px] font-[400] md:font-[500]">Add Wallets</h2>
              </button>
                ...
                <div className='mr-1 w-[11px] h-[11px]  md:w-[19.48px] md:h-[19.48px] 
                lg:w-[34px] lg:h-[34px] flex items-center'>
                  <img src="./Images/wallet/recovery-convert.png" alt="" className=' w-full h-full object-cover'/>
                </div>
                <h2 className='text-white text-[10px] leading-[14.5px] lg:text-[16px]
            ...
            <div className="mt-[25.39px] md:mt-[35px] lg:mt-[60px] px-2 py-2 flex flex-col gap-2" style={{boxShadow: `0px 0px 6.666667461395264px 0px rgba(0, 0, 0, 0.25)`}}>
              <div className='flex justify-between items-baseline font-bold border-b
               py-4 lg:text-[16px] lg:leading-[24px]'>
                <h2 className=' text-[13px] font-bold md:text-[14.5px] md:font-[500]'>Country</h2>
                <h2 className='text-[13px] font-bold md:text-[14.5px] md:font-[500]'>Currency</h2>
                <h2 className='text-[13px] font-bold md:text-[14.5px] md:font-[500]'>Balance</h2>
              </div>
              <div className="flex flex-col gap-2">
                {countryList.map((country) => (
                  ...
                  <div className="flex items-center">
                    <h2 className='text-slate-400 text-[12px] font-[400] md:text-[13px] md:font-[500]'>{country.name}</h2>
                    </div>
                    <Link to={country.name === "Nigeria" ? "/new-wallet" : false}
                   ...
                   if(country.name !== "Nigeria"){
                      ...
                      <div className='w-[10px] h-[35px] md:w-[15px] md:h-[15px] lg:w-[20px] lg:h-[20px] rounded-full overflow-hidden flex items-center justify-center'>
                        <img src={country.flag} alt="" className='h-[24px] w-[24px] md:w-[30px] md:h-[30px]'/>
                      </div>
                      <h2 className='text-right text-[12px] font-[400] md:text-[13px] md:font-[500]'>{country.code}</h2>
                    </Link>
                    <div className='flex gap-1 justify-end items-center text-slate-400'>
                      { currentId === country.id && clicked ? <h2 className="text-[12px] font-[400] md:text-[14px] md:font-[500]">{country.code}{amt}</h2> : <h2>*****</h2>}
