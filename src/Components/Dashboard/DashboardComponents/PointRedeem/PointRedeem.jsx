           ...
           <div className='flex flex-col w-full ' >
            {/* top part after nav bar */}
                ...
                <div className='mt-[20px] md:mt-[30px] lg:mt-[50px] flex flex-row '>
                    <div className='border-[1px] w-[85%] md:w-[92%] h-[30px] md:h-[40px] lg:h-[60px] px-2 py-0 md:pt-1 lg:pt-4 border-slate-200'><input type="number" className='w-[100%] outline-none text-[10px] lg:text-[16px] leading-[20.8px  font-[600]  text-[#000]' placeholder='Amount to Redeem' /> </div>
                ...
                <div className='mt-[7px] flex flex-row lg:mt-[20px]'>
                    <div className='border-[1px] w-[85%] md:w-[92%] h-[30px] md:h-[40px] lg:h-[60px] px-2 py-0 md:pt-1 lg:pt-4 border-slate-200'><input type="number" className=' w-[100%] outline-none text-[10px] lg:text-[16px] leading-[20.8px] font-[600] text-[#000]' placeholder='Amount to Receive' /> </div>
                    <div className='h-[30px] md:h-[40px] lg:h-[60px] w-[15%] md:w-[8%] gap-2 lg:gap-4 flex flex-row px-3 py-2 bg-primary items-center   '>
