...
import { PointRedeemSelector } from '../CountrySelect/PointRedeemSelector';
        ...
        <DashBoardLayout>
           <div className='flex flex-col w-full ' >
            {/* top part after nav bar */}
                <div className='flex flex-row w-full pt-[20px]  h-[90px] md:h-[112.29px] lg:h-[196px] lg:px-[50px]  px-[16px] rounded-lg lg:rounded-xl justify-between  py-2 bg-gradient-to-r from-[#92ABFE] to-[#FFF741]'>
                ...
                <div className='font-[500] text-[7px] py-1 mt-[20px] md:mt-[24px] lg:mt-[40px] text-center px-4 md:text-[9.17px] lg:text-[16px] leading-[20.8px] lg:px-6 lg:w-fit  md:flex md:flex-row md:w-fit md:py-1 lg:py-3 rounded-sm md:rounded-sm lg:rounded-md md:leading-[11.5px] bg-primary text-white'>Real-time Points Redeem Tracker</div>
                
                {/* Section with input boxes */}
                <div className='mt-[20px] md:mt-[30px] lg:mt-[50px] flex flex-row '>
                    <div className='border-[1px] w-[85%] md:w-[92%] h-[30px] md:h-[40px] lg:h-[60px] px-2 py-0 md:pt-1 lg:pt-4 border-slate-200'><input type="number" className=' outline-none text-[10px] lg:text-[16px] leading-[20.8px  font-[600]  text-[#000]' placeholder='Amount to Redeem' /> </div>
                ...
                <div className='mt-[7px] flex flex-row lg:mt-[20px]'>
                    <div className='border-[1px] w-[85%] md:w-[92%] h-[30px] md:h-[40px] lg:h-[60px] px-2 py-0 md:pt-1 lg:pt-4 border-slate-200'><input type="number" className=' outline-none text-[10px] lg:text-[16px] leading-[20.8px] font-[600] text-[#000]' placeholder='Amount to Receive' /> </div>
                    <div >
          ...
          />
                ...
                <div className='flex flex-row items-center justify-center mt-[150px] md:mt-[38%] lg:mt-[26%] gap-2'>
