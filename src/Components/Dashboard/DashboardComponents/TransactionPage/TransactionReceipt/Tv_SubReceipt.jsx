   ...
   const handleShareClick = async() => {
     ...
     //  alert(pdf.internal?.pageSize.getHeight())
      ...
      if (navigator.canShare && navigator.canShare({files : [file]})) {
        navigator
          .share({
            title: `AremxyPlug_${receiptData?.decoder_type?.toUpperCase()}_Receipt`,
            files : [file], 
          })
          .then(() => {return;})
          .catch((error) => {return});
    ...
    if (content) {
      ...
      html2canvas(content).then((canvas) => {
        ...
        if (bgPdf) {
          ...
          pdf.text(`${description} Receipt`, 20, 20);
        }
      });
    }
  };
        ...
        <div className="flex flex-col gap-[35px] lg:gap-[85px]">
          ...
          >
            ...
            <div ref={contentRef}>
              {" "}
              <h3
                className="font-extrabold text-xs my-[2%] 
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-[5px] w-[90%] mx-auto lg:gap-[10px]">
                 ...
                 lg:text-base"
                  ...
                  <div
                    className="flex text-[10px] font-medium md:text-sm w-[90%]
