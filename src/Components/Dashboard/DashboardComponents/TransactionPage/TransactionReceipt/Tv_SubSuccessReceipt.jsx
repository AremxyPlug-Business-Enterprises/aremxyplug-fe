...
export const TvSubSuccessReceipt = () => {
      ...
      <div className="flex flex-col gap-[35px] lg:gap-[85px]">
        ...
        >
          ...
          <div ref={contentRef}>
            {" "}
            <h3
              className="font-extrabold text-[12px] my-[2%] 
          ...
          `}
            ...
            <p
              className={`text-[10px] p-[5.729px] border-[0.573px] rounded-[6.302px]
            ...
            >
              {tvSubscriptionResponse?.data?.status === "delivered"
                ...
                : purchaseGotvErrorType}
              <span
                className="font-extrabold text-[10.9px] md:text-[14.9px] 
              lg:text-[16.9px]"
              >
                {selectedOptionGOTV}{" "}
              </span>
              from your <span>{flagResult} to </span>
            </p>
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-[5px] w-[90%] mx-auto lg:gap-[10px]">
                ...
                <div
                  className="flex text-[10px] font-[500] md:text-[14px] w-[90%]
            ...
            <div
              className={`bg-[#F2FAFF] w-[90%]   mx-auto p-[8px] my-5 flex justify-between 
          ...
          <div className="flex w-[70%] mx-auto mb-[5%] md:w-[60%] ">
            ...
            <button
              ...
              className={`bg-[#ffffff]   border-[1px] w-[111px] border-[#0003] flex justify-center items-center 
                mx-auto cursor-pointer text-[12px] font-extrabold  ${
                  isDarkMode
