...
import CheckRate from "./OtherBankPopUp/CheckRate";
import { CountrySelectorCopy } from "../../CountrySelect/CountrySelectorCopy";
  ...
  return (
    <div>
      ...
      <div
        ...
        className="cursor-pointer bg-[#04177f] text-[#fff] text-[10px] h-[20px] flex justify-center items-center rounded-[2px] md:mt-[5%] md:text-[14px] md:h-[35px] lg:text-[16px] lg:h-[38px] lg:w-[50%]"
      >
      ...
      <div className={``}>
        <div className="border h-[25px] flex justify-between pl-[2%] md:h-[45px] lg:h-[45px] lg:border-[1px] lg:border-[#0003]">
          ...
          <input
            ...
            className={`${styles.hideArrows} text-[10px] w-[90%] h-[100%] outline-none md:text-[16px] lg:text-[16px]`}
          />
          <CountrySelectorCopy
      ...
      <div className={``}>
        <div className="border rounded-[px] h-[25px] flex justify-between pl-[2%] md:h-[45px] lg:h-[45px] lg:border-[1px] lg:border-[#0003]">
          ...
          <input
            ...
            className={`${styles.hideArrows} text-[10px] w-[90%] h-[100%] outline-none md:text-[14px] lg:text-[16px]`}
          />
          <CountrySelector
            className="lg:w-[164px]"
            onSelect={handleCountrySelect}
