...
export const InternationalTransactionSuccessPopUp = ({
  internationalTransactSuccess,
  setInternationalTransactSuccess,
}) => {
  const {
    toggleSideBar,
    transferFee,
        ...
        <Modal>
          ...
          >
            <div className="flex justify-between items-center mx-[3%] my-[2%] lg:my-[1%]">
              <img
                onClick={() => setInternationalTransactSuccess(false)}
            ...
            <div className="flex w-[70%] mx-auto items-center gap-[5%] md:w-[60%] lg:my-[5%]">
              ...
              <Link to="/international-bank-receipt">
                <button
                  onClick={handleTransactionSuccessClose}
