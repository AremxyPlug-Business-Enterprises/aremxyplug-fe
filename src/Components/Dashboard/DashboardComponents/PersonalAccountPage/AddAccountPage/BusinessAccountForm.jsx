    ...
    <>
      <div className="mt-[4%] flex flex-col gap-[10px] md:grid md:grid-cols-2 md:gap-[5%] h-[] lg:w-[90%]">
        ...
        <div className={styles.inputBox}>
          ...
          <div className="border text-[10px] rounded-[5px] h-[25px] flex justify-between items-center p-1 lg:text-[14px] lg:h-[45px] lg:rounded-[10px] lg:border-[1px] lg:border-[#0003]">
            {countryCode}
          </div>
          {errors.currency && (
            <div className="text-[12px] text-red-500 italic lg:text-[14px]">
