        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
              ...
              {showProductList && (
                <div className="border md:rounded-[10px] text-[14px]  md:text-[12px] lg:text-[16px] mt-20 lg:mt-20 w-[90%] md:w-[44%]  rounded-[4px] absolute  bg-[#FFF] z-[10]">
                  {productList.map((item) => (
                    <div
                      key={item.name}
                      className={`pb-[18px] md:pb-0 pt-[18px] md:pt-0 font-weight-bold text-[14px] cursor-pointer border-b-[0.5px] text-[#7C7C7C] md:text-[12px] lg:text-[16px] w-[100%]  md:rounded-[0px] lg:mt-2 py-[4px] text-[13px] pl-[5px] ${selectedNetworkProduct === item.name ? "bg-white" : ""
                        }`}
            ...
            <div className="flex flex-col mt-[14px] md:mt-[23px] lg:mt-[23px]">
              ...
              <div>
                <input type="number" value={meterNumber} onChange={handleMeterNumber} className=" w-full text-[#7E7E7E] pl-[9px] lg:h-[51px] lg:text-[16px]  text-[13px] font-[500]  border-[1px] h-[40.927px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[20px]  md:p-0 text-[13px] p-4 sm:p-3 sm:text-lg " />{" "}
              </div>
              {errors.meterNumber && (
            ...
            <div className="flex flex-col mt-[12px]">
              ...
              <div>
                <input type="text" value={ikedcEmail} onChange={handleEmail} className=" w-full lg:h-[51px] text-[#7E7E7E] pl-[9px] lg:text-[16px] text-[13.8px] font-[500]  border-[1px] h-[40.927px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[20px]  md:p-0 text-[13px] p-4 sm:p-3 sm:text-lg " />
              </div>
              {errors.ikedcEmail && (
                <div className="text-[12px] text-red-500 italic lg:text-[14px]">
                  {errors.ikedcEmail}
            ...
            <div className="flex flex-col mt-[10px]">
              ...
              <div className="flex items-center lg:text-[16px] text-[#7E7E7E] text-[1px] pl-2 border-[1px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[8px]  md:p-0 text-[14px] p-4 sm:p-3 sm:text-lg">
                &#8358;
