    ...
    return ( 
       ...
       <DashBoardLayout>
        ...
        <div className=" flex lg:mt-[20px] text-[10px] lg:text-[16px] font-[600] pt-[30px] text-[#7E7E7E] items-center "> 
            ...
            <div className="bg-gradient-to-b mt-[10px] lg:mt-[15px] border-[1px] border-[] from-[#E2F3FF] font-[700] text-[10px] lg:text-[16px] lg:rounded-sm lg:py-2 text-center lg:px-3 py-1 to-[#FFF]">Eko Electric Covers: Apapa | Lekki | Ibeju | Island | Agbara | Ojo | Festac | Ijora | Mushin | Orile</div>
            </div>
