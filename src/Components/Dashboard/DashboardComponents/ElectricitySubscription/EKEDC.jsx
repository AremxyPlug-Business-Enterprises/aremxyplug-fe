      ...
      <div className={` ${isDarkMode
        ...
        <div>
          ...
          <div className=" flex lg:mt-[20px] text-[12px] lg:text-[16px] font-[600] pt-[30px] text-[#7E7E7E] items-center ">
            ...
            <div className=" ml-1">Eko Electric Payment-EKEDC Meter Instantly</div>
            <div><img className="lg:w-[24px]" src={arrow} alt="" /></div>

          </div>
          <div className="lg:flex lg:items-start ">
            <div className="bg-gradient-to-b mt-[10px] lg:mt-[15px] border-[1px] border-[] from-[#E2F3FF] font-[700] text-[10px] lg:text-[16px] lg:rounded-sm lg:py-2 text-center lg:px-3 py-1 to-[#FFF]">Eko Electric Covers: Apapa | Lekki | Ibeju | Island | Agbara | Ojo | Festac | Ijora | Mushin | Orile.
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
            <div className=" flex flex-col mt-[20px] gap-1">
              ...
              >
                ...
                <button className="lg:w-6 lg:h-6 w-[11px] h-[13x]">
                  <img src={arrowDown} alt="" className="w-full h-full" />
                </button>
              </div>
              {showProductList && (
                <div className="border md:rounded-[10px] text-[14px]  md:text-[12px] lg:text-[16px] mt-20 lg:mt-20 w-[90%] md:w-[44%]  rounded-[4px] absolute  bg-[#FFF] z-[10]">
            ...
            <div className="flex flex-col mt-[14px] md:mt-[23px] lg:mt-[23px]">
            ...
            <div className="flex flex-col mt-[10px]">
              ...
              <div className="flex items-center lg:text-[16px] text-[#7E7E7E] text-[12px] pl-2 border-[1px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[8px]  md:p-0 text-xl p-4 sm:p-3 sm:text-lg">
                &#8358;
        ...
        <Modal>
          ...
          >
            ...
            <div className="flex w-[70%] mx-auto items-center my-6  gap-[6%] md:gap-[20px] justify-center md:w-[20%] lg:my-[5%]">
              ...
              <Link to="/ekedc-receipt-failed" state={{
                selectedNetworkProduct: selectedNetworkProduct,
                meterNumber: meterNumber,
                phoneNumber: phoneNumber,
                ikedcEmail: ikedcEmail,
