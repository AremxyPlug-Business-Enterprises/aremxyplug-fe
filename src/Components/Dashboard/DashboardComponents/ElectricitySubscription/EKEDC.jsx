      ...
      <div className={` ${isDarkMode
        ...
        <div>
         ...
         isDarkMode
            ...
            }`}>Eko Electric Covers: Apapa | Lekki | Ibeju | Island | Agbara | Ojo | Festac | Ijora | Mushin | Orile.
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
              ...
              isDarkMode
                ...
                : "bg-[#FFF]"
                  ...
                  {productList.map((item) => (
                    <div
                      key={item.name}
                      className={`pb-[18px] md:pb-[14px] pt-[18px] md:pt-[14px] font-weight-bold text-[14px] cursor-pointer border-b-[0.5px] text-[#7C7C7C] md:text-[12px] lg:text-[16px] w-[100%]  md:rounded-[0px] lg:mt-2 py-[4px] text-[13px] pl-[5px] 
                               ${
              isDarkMode
                ? "text-white bg-black"
                : "bg-white"
            ...
            <div className="flex flex-col mt-[12px]">
              ...
              <div>
                <input type="text" value={ikedcEmail} onChange={handleEmail} className={`w-full lg:h-[51px]  pl-[9px] lg:text-[16px] text-[13.8px] font-[500]  border-[1px] h-[40.927px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[20px]  md:p-0 text-[13px] p-4 sm:p-3 sm:text-lg  ${
              isDarkMode
                ? "text-white bg-black border border-white"
                : "text-[#7E7E7E]"
            }`}/>
            ...
            <div className="flex flex-col mt-[10px]">
              ...
              <div className={`flex items-center lg:text-[16px]  text-[1px] pl-2 border-[1px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[8px]  md:p-0 text-[14px] p-4 sm:p-3 sm:text-lg  ${
              isDarkMode
                ? "text-white bg-black border border-white"
                : "text-[#7E7E7E]"
            }`}>
