          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
            ...
            <div className="flex flex-col gap-2 relative lg:gap-2.5">
              ...
              {errors.jedPhoneNumber && (
                <div
                  className={`text-sm absolute left-0 -bottom-[1.5rem] leading-3 text-red-500 italic lg:text-sm`}
                >
                  {errors.jedPhoneNumber}
                </div>
              )}
        ...
        <Modal>
          ...
          >
            ...
            <button
              ...
              className={`bg-[#04177f] my-[5%] w-[88%] flex justify-center items-center mx-auto cursor-pointer text-sm font-extrabold h-[40px] text-white rounded-[6px] md:w-[25%] md:rounded-[8px] md:text-base lg:text-sm lg:w-[163px] lg:h-[38px] lg:my-[2%] ${
