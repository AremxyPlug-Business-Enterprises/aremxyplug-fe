          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
            ...
            <div className="flex flex-col gap-2 relative lg:gap-2.5">
              ...
              {errors.aedcPhoneNumber && (
                <div className="text-xs text-red-500 absolute left-0 -bottom-[1.5rem] leading-3 italic lg:text-sm">
                  {errors.aedcPhoneNumber}
                </div>
              )}
            </div>
      ...
      {successPopup && (
        <Modal>
          ...
          >
            ...
            <h2 className="text-xs my-[4%] text-center md:text-[20px] font-semibold md:my-[3%] lg:text-sm lg:my-[2%]">
              Purchase Successful
            </h2>
            <img
