            ...
            <div className=" w-full flex flex-col md:flex-row gap-5 md:gap-3 lg:gap-[22px] md:my-2 lg:my-4 ">
              ...
              <div className=" container-phone relative flex flex-col gap-[3px] lg:gap-[5px] w-full md:w-1/2">
                ...
                {errors.aedcPhoneNumber && (
                  <div className="text-xs text-red-500 absolute left-0 -bottom-4 sm:-bottom-[1.5rem] leading-3 italic lg:text-sm">
                    {errors.aedcPhoneNumber}
                  </div>
                )}
              </div>
          ...
          >
            ...
            >
              ...
              <span className="text-[#000] font-extrabold text-[10px] md:text-base lg:text-xs">
                ...
                <div
                  // className="flex flex-col gap-3 pt-[10px]"
                ...
                >
                  ...
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between font-medium lg:text-base items-center">
                    ...
                    <span>Nigerian {aedcPaymentResult.split(" (")[0]}</span>
                  </div>
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between font-medium lg:text-base items-center">
                    <p
                      className={`${
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex gap-[10px] justify-center items-center">
                    ...
                    <div className="flex gap-[10px] items-center font-medium">
                      ...
                      >
                        {aedcWalletBalance !== "" ? aedcWalletBalance : "₦"}
                      </span>
                    </div>
                  </div>
        ...
        <Modal>
          ...
          >
            ...
            >
              ...
              <div className="">
                <h2
                  // className="text-xs my-[4%] text-center md:text-[20px] font-semibold md:my-[3%] lg:text-sm lg:my-[2%]"
                  className="text-xs my-[4%] font-medium text-center md:text-[20px] md:my-[3%] lg:text-sm lg:my-[2%]"
                >
                  Purchase Successful
                </h2>
                <img
                ...
                <div className="flex mt-4 flex-col gap-2 lg:gap-4">
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between lg:text-[15px] font-medium">
                    ...
                    <div className="flex items-center gap-1 ">
                      <img
                        // className=" w-[12.02px] h-[12.02px] md:w-[12.02px] lg:w-[25px] md:h-[12.02px] lg:h-[25px] capitalize"
                        className="w-[30px]"
                        src={logo}
                        alt=""
                      />
                      <span className="capitalize">{aedcDiscoType}</span>
                    </div>
                  </div>
                  <div
                    // className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between lg:text-base"
                    className="flex text-[10px] md:text-sm w-[90%] mx-auto items-center justify-between lg:text-[15px] font-medium"
                  >
                    <p
                      className={` ${
                        isDarkMode ? "text-white" : "text-[#7C7C7C] "
