    ...
    return ( 
       ...
       <DashBoardLayout>
        ...
        <div className=" flex lg:mt-[20px] text-[10px] lg:text-[16px] font-[600] pt-[30px] text-[#7E7E7E] items-center "> 
            <div>Recharge</div>
            <div><img className="lg:w-[99px] w-[25px] ml-1" src={logo} alt="" /></div>
        ...
        <div
          ...
          <footer className="flex justify-center text-center pb-[50px] gap-[20px] mt-[170px] mb-[100px] md:mt-[750px] lg:mb-[130px] lg:mt-[850px]">
      ...
      {successPopup && (
        <Modal>
          ...
          >
            ...
            <div className="flex w-[70%] mx-auto items-center gap-[6%] md:gap-[20px] justify-center my-6 md:w-[20%] lg:my-[5%]">
              <button
                onClick={() => {
