      ...
      >
        ...
        >
          ...
          <div ref={contentRef}>
            ...
            <p className="text-[9px] text-[#F95252] bg-[#FDCECE] rounded-[11px] border-2 font-medium border-[#F95252] py-[5px] px-[2px] text-center mx-[3px] lg:mx-[130px] md:mx-[80px] my-2 md:text-[14px] lg:text-[14px]">
              {message}
            </p>
