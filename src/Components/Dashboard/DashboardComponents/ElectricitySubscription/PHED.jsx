  ...
  const handleSwitch = () => {
    ...
    return ( 
       ...
       <DashBoardLayout>
        ...
        <div className=" flex lg:mt-[20px] text-[9px] lg:text-[16px] font-[600] pt-[30px] text-[#7E7E7E] items-center "> 
            <div>Recharge</div>
            <div><img className="w-[30px] lg:w-[77px] ml-1"  src={logo} alt="" /></div>
