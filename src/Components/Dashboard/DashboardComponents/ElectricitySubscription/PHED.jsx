      ...
      <div className={` ${isDarkMode
        ...
        <div>
          ...
          <div className=" flex lg:mt-[20px] text-[12px] lg:text-[16px] font-[600] pt-[30px] text-[#7E7E7E] items-center ">
            ...
            <div className=" ml-1">PHED-Port-Harcourt Electric Payment Meter Instantly</div>
            ...
            <div className={` mt-[10px] lg:mt-[15px] border-[1px] border-[] from-[#E2F3FF] font-[700] text-[10px] lg:text-[16px] lg:rounded-sm lg:py-2 text-center lg:px-3 py-1 to-[#FFF]
              ${
                      isDarkMode
                        ...
                        : "bg-gradient-to-b"
                    }`}>Port Harcourt Electric Covers: Rivers | Akwa Ibom | Bayelsa | Cross River.
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
            <div className=" flex flex-col mt-[20px] gap-1">
              ...
              {showProductList && (
                <div className={`border md:rounded-[12px] text-[14px] md:text-[12px] lg:text-[16px] mt-20 lg:mt-20 w-[90%] md:w-[44%]  rounded-[4px] absolute  z-[10]
                   ${
                      isDarkMode
                        ? "text-white bg-black border border-white"
                        : "text-[#FFF]"
            ...
            <div className="flex flex-col mt-[10px]">
              <div className="text-[#7E7E7E] text-[14px] lg:text-[16px] md:font-[600] font-[400]" >Phone Number</div>
              <div>
                <input type="number" value={phoneNumber} onChange={handlePhoneNumber} className={`w-full  lg:h-[51px] lg:text-[16px]  pl-[9px] text-[13px] font-[500]  border-[1px] h-[40.927px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[20px]  md:p-0 text-[13px] p-4 sm:p-3 sm:text-lg   ${
                      isDarkMode
                        ? "text-white bg-black border border-white"
                        : ""
                    }`} />
            ...
            <div className="flex flex-col mt-[10px]">
              ...
              <div className={`flex items-center lg:text-[16px] text-[10px] pl-2 border-[1px] rounded-[10px]    ${
                      isDarkMode
                        ? "text-white bg-black border border-white"
                        : "text-[#7E7E7E] "
                    }`}>
                &#8358;
                <input type="number" name="ikedcamount" value={ikedcamount} onChange={handleIkedcAmount} className={`w-full outline-none lg:h-[51px] lg:text-[16px]  pl-[9px] text-[14px] font-[500]   h-[40.927px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[8px]  md:p-0 text-[13px] p-4 sm:p-3 sm:text-lg 
                  ${
                      isDarkMode
                        ? "text-white bg-black"
                        : "text-[#7E7E7E] "
          ...
          >
            ...
            <p className="text-[8px] lg:text-[16px] font-[500] text-[#000] text-center mb-2 md:text-[14px] ">
              ...
              <span className="text-[#000] font-extrabold text-[10px] md:text-[16px] lg:text-[14px]">
                Port-Harcourt {selectedNetworkProduct} Meter
              </span>{" "}
              <br></br>
              <span className="text-[#000] font-extrabold text-[10px] md:text-[16px] lg:text-[14px]">
                (&#8358;{ikedcamount}){" "}
        ...
        <Modal>
          ...
          >
            ...
            <div className="flex w-[70%] mx-auto items-center my-6  gap-[6%] md:gap-[20px] justify-center md:w-[20%] lg:my-[5%]">
              ...
              <Link to="/phed-receipt-failed" state={{
                selectedNetworkProduct: selectedNetworkProduct,
                meterNumber: meterNumber,
                phoneNumber: phoneNumber,
                ikedcEmail: ikedcEmail,
