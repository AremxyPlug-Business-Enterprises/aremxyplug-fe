    ...
    return ( 
       ...
       <DashBoardLayout>
        ...
        <div className=" flex lg:mt-[20px] text-[10px] lg:text-[16px] font-[600] pt-[30px] text-[#7E7E7E] items-center "> 
            <div>Recharge</div>
            <div><img className="w-[35px] lg:w-[51px] ml-1"  src={logo} alt="" /></div>
            <div className=" ml-1">Ibadan Electric Payment-IBEDC Meter Instantly</div>
            <div><img className="lg:w-[24px]" src={arrow} alt="" /></div>

            </div>  
            <div className="lg:flex lg:items-start ">
            <div className="bg-gradient-to-b mt-[10px] lg:mt-[15px] border-[1px] border-[] from-[#E2F3FF] font-[700] text-[10px] lg:text-[16px] lg:rounded-sm lg:py-2 text-center lg:px-3 py-1 to-[#FFF]">Ibadan Electric Covers: Oyo | Ogun | Osun | Kwara | Parts of: Niger, Ekiti and Kogi States.
</div>
            </div>
            ...
            <div className="flex flex-col gap-3 pt-[10px]">
              <div className="flex text-[10px] md:text-[14px] pt-[10px] w-[90%] mx-auto justify-between  lg:text-[16px]">
                ...
                <span className="flex items-center gap-1 ">
                  <div><img className="w-[28px]" src={logo} alt="" /></div>
