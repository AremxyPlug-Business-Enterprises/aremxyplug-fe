...
const GetBalance = async () => {
  ...
  const handleCountryClick = (name, flag, id, code, balance) => {
    ...
    setAmountError("");
    setSelected(true);
    setIbedcWalletBalance(balance);
    setIbedcPaymentResult(`${name} ${balance}`);
    // setCountryCode(code);
  ...
  const verifyPin = async () => {
    async function ElectricityHandler() {
      ...
      const SuccessHandler = (response) => {
        ...
        setIbedcDiscoType(response?.data?.data?.data?.disco_type);
        ...
        : "hover:bg-[#EDEAEA]"
              ...
              <div className="relative flex flex-col gap-[3px] lg:gap-[5px] w-full md:w-1/2 ">
                ...
                <input
                  ...
                  onChange={(e)=> {
                    setIbedcMeterNumber(e.target.value);
                      if(timer.current) clearTimeout(timer.current)   
                timer.current = setTimeout(()=> {
              //Run every 5 seconds
                handleIbedcMeterNumber(e)
      ...
      isDarkMode
        ...
        : "hover:bg-[#EDEAEA]"
                ...
                {errors.ibedcPhoneNumber && (
                  <div className="text-sm absolute left-0 -bottom-4 sm:-bottom-[1.5rem] leading-3 text-red-500 italic lg:text-sm">
                    {errors.ibedcPhoneNumber}
                  </div>
                )}
              </div>
        ...
        : "hover:bg-[#EDEAEA]"
                ...
                >
                  ...
                  <input
                    ...
                    className={`w-full ml-0.5 placeholder:text-base outline-none placeholder:leading-[10.4px] placeholder:lg:text-base placeholder:lg:leading-[20.8px] focus:outline-none
            ...
            >
              ...
              <span className="text-[#000] font-extrabold text-[10px] md:text-base lg:text-base">
                &#8358;{}
                  ...
                  from your {ibedcPaymentResult.split(" (")[0]} to
                </p>
                ...
                <div className="flex flex-col gap-3 mt-5 md:mt-6 lg:mt-7">
                  ...
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between font-medium items-center lg:text-base">
                    ...
                    <span>
                      {ibedcAmount
                        ? `₦${Number(ibedcAmount).toLocaleString()}.00`
                        : "₦"}
                    </span>
                  </div>
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between font-medium items-center lg:text-base">
                    ...
                    <span>Nigerian {ibedcPaymentResult.split(" (")[0]}</span>
                  </div>
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between font-medium items-center lg:text-base">
                    <p
                      className={` ${
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex gap-[10px] justify-center items-center">
                    ...
                    <div className="flex gap-[10px] items-center font-medium">
                      ...
                      >
                        {ibedcWalletBalance !== "" ? ibedcWalletBalance : "₦"}
                      </span>
                    </div>
                  </div>
                ...
                <div className="flex mt-4 flex-col gap-2 lg:gap-4">
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between items-center lg:text-[15px] font-medium">
                    ...
                    <div className="flex items-center gap-1 ">
                      ...
                      <span className="capitalize">{ibedcDiscoType}</span>
                    </div>
                  </div>
