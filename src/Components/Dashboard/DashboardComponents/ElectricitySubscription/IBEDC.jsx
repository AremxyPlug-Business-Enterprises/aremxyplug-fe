...
import logo from "../ElectricitySubscription/Electricity-sub-images/ibedc-logo 1.svg";
...
const IBEDC = () => {
  ...
  const handleProceed = (e) => {
    ...
    const amount = Number(ibedcAmount);
    const network = validateNigerianNumberByNetwork(ibedcPhoneNumber);
    if (error) {
      setErrors(
    ...
    <DashBoardLayout>
      ...
      >
        <div>
          ...
          <div className="flex flex-row w-full pt-[10px] min-h-[91px] md:h-[112.29px] lg:h-[196px] lg:px-[50px]  px-[16px] rounded-lg md:rounded-[11.5px] lg:rounded-[20px] justify-between  py-0 bg-gradient-to-r from-[#FFA733] via-[#58FF4A] to-[#98B0FF]">
            <div className="flex flex-col gap-2  ">
              <div className="text-[11px] font-semibold  pt-[10px] md:text-base md:leading-[20.63px] lg:pt-[25px] lg:text-[24px] lg:leading-[36px] text-[#000000] leading-[12px]">
          ...
          <div
            className={`flex lg:mt-[20px] text-[10px] md:text-base lg:text-base font-semibold pt-[30px] items-center ${
              isDarkMode ? "text-white" : "text-[rgb(126,126,126)]"
            }`}
          >
          ...
          <div className="lg:flex lg:items-start ">
            <div
              className={`mt-[12px] lg:mt-[15px] border from-[#E2F3FF] font-bold text-[10px] lg:text-base lg:rounded-sm lg:py-2 text-center lg:px-3 py-1 to-[#FFF]
             ${
               isDarkMode
            ...
            >
              Ibadan Electric Covers: Oyo | Ogun | Osun | Kwara | Parts of:
              Niger, Ekiti and Kogi States.
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
            ...
            <div className="flex flex-col relative gap-2 lg:gap-2.5 mt-5">
              ...
              <div>
                <input
                  ...
                  className={`py-3 pl-[5.867px] lg:py-[14px] lg:pl-[10px] border md:py-3 md:pl-[8.67px] pr-1 md:pr-[5.867px] text-base leading-[18px] border-[#9C9C9C] lg:text-base lg:leading-[20.8px] focus:outline-none placeholder:text-base placeholder:leading-[10.4px] placeholder:lg:text-base placeholder:lg:leading-[20.8px] rounded-lg sm:rounded-[10px] h-full w-full  ${
                    isDarkMode
                ...
                {errors.ibedcMeterNumber && (
                  <div
                    className={`text-sm absolute left-0 -bottom-[1.3rem] text-red-500 italic lg:text-sm
                `}
              ...
              <div>
                <input
                  ...
                  className={`w-full py-3 pl-[5.867px] lg:py-[14px] lg:pl-[10px] md:py-3 md:pl-[8.67px] pr-1 md:pr-[5.867px] text-xs leading-[18px] lg:text-base lg:leading-[20.8px] focus:outline-none placeholder:text-xs placeholder:leading-[10.4px] placeholder:lg:text-base placeholder:lg:leading-[20.8px] rounded-lg sm:rounded-[10px] h-full  ${
                    isDarkMode
                      ? "text-white bg-black border border-white"
                      : "text-[#7E7E7E] bg-white border border-[#9C9C9C]"
                  }`}
                />
              </div>
              {errors.ibedcPhoneNumber && (
                <div className="text-base absolute left-0 -bottom-[1.5rem] leading-3 text-red-500 italic lg:text-sm">
                  {errors.ibedcPhoneNumber}
                </div>
              )}
            </div>
            ...
            <div className="flex flex-col relative gap-2 lg:gap-2.5">
              ...
              {amountError && (
                <p className="text-sm absolute left-0 -bottom-[1.3rem] text-red-500 italic md:text-sm">
                  {amountError}
                </p>
              )}
            </div>
          ...
          <div
            ...
            className={`text-base mt-[30px] md:mt-[40px] bg-[#0008] md:w-fit lg:px-12 lg:text-base lg:px md:py-1 md:rounded-md md:px-6 py-3 rounded-md font-semibold text-center text-white
            ${
              !ibedcMeterNumber ||
              !ibedcCustomerName ||
              !ibedcPhoneNumber ||
        ...
        <footer className="flex justify-center text-center gap-[20px] mt-[200px] pb-[10%] md:mt-[750px]  lg:mt-[850px]">
          <p className="text-[11px] md:text-base lg:text-[18px] font-medium leading-[9.1px] mt-[5px] lg:mt-[13px]">
            You need help?
          </p>
      ...
      {proceed && (
        <Modal>
          <div
            className={`${
              isDarkMode
                ? "absolute h-[505px] shrink-0 bottom-0 shadow-[0px_0px_7.068181991577148px_0px_rgba(0,0,0,0.25)] rounded-[8px] md:h-[620px] md:rounded-xl md:rounded-tr-[0px] md:bottom-[30%] lg:h-[550px] lg:rounded-[20px] lg:rounded-tr-[0px] lg:bottom-[7%] bg-black border border-white text-white"
          ...
          >
            ...
            <h2 className="text-base font-semibold my-[5%] text-center md:my-[3%] md:text-[15px] lg:my-[2%] lg:text-base">
              Confirm Transaction
            </h2>
            <p
              className={`text-[10px] pt-[20px] font-medium text-center mb-2 md:text-base lg:text-sm ${
                isDarkMode ? "text-white" : "text-[#000]"
              }`}
            >
              You are about to Purchase{" "}
              <span
                className={`font-extrabold text-[10px] md:text-sm lg:text-base ${
                  isDarkMode ? "text-white" : "text-[#000]"
                }`}
              >
                {selectedIbedcMeterType} Meter (&#8358;
                {Number(ibedcAmount).toLocaleString()}){" "}
              </span>
              {/* Points to <br></br>
              <span className="text-[#000] font-extrabold text-[10px] md:text-base lg:text-base">
                &#8358;{}
              </span> */}
      ...
      {InputPinPopUp && (
        <Modal>
          ...
          >
            ...
            />
            <p className="text-base md:text-base font-extrabold text-center my-[10%] lg:my-[%] ">
            ...
            <div className="flex flex-col gap-[10px] justify-center items-center font-extrabold mb-[8%]">
              ...
              <p className="text-[10px] md:text-base text-[#04177f]">
                Forgot Pin ?
              </p>
            </div>
            <button
      ...
      {successPopup && (
        <Modal>
          ...
          >
            ...
            <h2 className="text-base my-[4%] text-center md:text-[20px] md:my-[3%] lg:text-sm lg:my-[2%]">
              Purchase Successful
            </h2>
            <img
            ...
            >
              <p
                // className="text-[8px] md:pt-1 text-center w-full h-full md:text-sm lg:text-sm font-semibold"
                className="text-[8px] text-center md:text-sm md:w-[97%] lg:w-[90%] md:mx-auto lg:text-sm font-medium"
              >
            ...
            <div className="flex w-[70%] mx-auto items-center my-6 gap-[6%] md:gap-[20px] justify-center md:w-[20%] lg:my-[5%]">
              <button
                ...
                className={`bg-[#04177f] w-[111px] flex justify-center items-center mx-auto cursor-pointer text-base font-extrabold h-[40px] text-white rounded-[6px] md:px-[50px] md:w-[70%] md:rounded-[8px] md:text-base lg:w-[163px] lg:h-[38px] lg:my-[2%]`}
              >
                Done
              </button>
              ...
              <button
                ...
                className={`border w-[111px] border-[#04177f] flex justify-center items-center md:px-[50px] mx-auto cursor-pointer text-base font-extrabold h-[40px] rounded-[6px] md:w-[80px] md:rounded-[8px] md:text-base lg:w-[163px] lg:h-[38px] lg:my-[2%]`}
              >
                Receipt
              </button>
            </div>
      ...
      {failedPopup && (
        <Modal>
          ...
          >
            ...
            <hr className="h-[6px] bg-[#04177f] border-none md:h-[10px]" />
            <h2 className="text-base my-[5%] text-center md:text-[20px] md:my-[3%] lg:text-sm lg:my-[2%]">
              Transaction Failed
            </h2>
            <img
            ...
            />
            <p
              className={`text-base mx-[10px] text-center my-[60px] md:text-sm lg:text-base ${
            ...
            <div className="flex w-[70%] mx-auto items-center my-6  gap-[6%] md:gap-[20px] justify-center md:w-[20%] lg:my-[5%]">
              ...
              <button
                ...
                className={`border w-[111px] border-[#04177f] flex justify-center items-center mx-auto cursor-pointer text-base font-extrabold h-[40px] rounded-[6px] md:w-[80px] md:px-[50px] md:rounded-[8px] md:text-base lg:w-[163px] lg:h-[38px] lg:my-[2%]`}
              >
                Receipt
              </button>
            </div>
