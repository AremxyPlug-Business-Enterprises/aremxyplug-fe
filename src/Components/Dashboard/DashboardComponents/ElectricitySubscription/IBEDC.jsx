      ...
      <div className={` ${isDarkMode
        ...
        <div>
          ...
          <div className="lg:flex lg:items-start ">
            <div className="bg-gradient-to-b mt-[12px] lg:mt-[15px] border-[1px] border-[] from-[#E2F3FF] font-[700] text-[10px] lg:text-[16px] lg:rounded-sm lg:py-2 text-center lg:px-3 py-1 to-[#FFF]">Ibadan Electric Covers: Oyo | Ogun | Osun | Kwara | Parts of: Niger, Ekiti and Kogi States.
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
            <div className=" flex flex-col mt-[20px] gap-1">
              <div className="text-[#7E7E7E] text-[14px] lg:text-[16px]  font-[600]">Select Meter Type</div>
              <div
              ...
              {showProductList && (
                <div className="border md:rounded-[12px] text-[10px] md:text-[12px] lg:text-[16px] mt-20 lg:mt-20 w-[90%] md:w-[44%]  rounded-[4px] absolute  bg-[#FFF] z-[10]">
