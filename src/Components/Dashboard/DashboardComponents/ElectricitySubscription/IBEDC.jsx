      ...
      >
        <div>
          ...
          <div className="lg:flex lg:items-start ">
            <div
              className={`mt-[12px] lg:mt-[15px] border from-[#E2F3FF] font-bold text-[10px] lg:text-[16px] lg:rounded-sm lg:py-2 text-center lg:px-3 py-1 to-[#FFF]
             ${
               isDarkMode
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
            ...
            <div className="flex flex-col relative gap-2 lg:gap-2.5">
              ...
              {errors.ibedcPhoneNumber && (
                <div className="text-[12px] absolute left-0 -bottom-[1.5rem] leading-3 text-red-500 italic lg:text-[14px]">
                  {errors.ibedcPhoneNumber}
                </div>
              )}
            </div>
          ...
          >
            ...
            <div className="flex w-[70%] mx-auto items-center my-6 gap-[6%] md:gap-[20px] justify-center md:w-[20%] lg:my-[5%]">
              ...
              <button
                ...
                className={`border w-[111px] border-[#04177f] flex justify-center items-center md:px-[50px] mx-auto cursor-pointer text-[12px] font-extrabold h-[40px] rounded-[6px] md:w-[80px] md:rounded-[8px] md:text-[16px] lg:w-[163px] lg:h-[38px] lg:my-[2%]`}
              >
                Receipt
              </button>
            </div>
