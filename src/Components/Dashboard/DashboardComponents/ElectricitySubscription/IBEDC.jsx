      ...
      <div className={` ${isDarkMode
        ...
        <div>
          ...
          <div className=" flex lg:mt-[20px] text-[12px] lg:text-[16px] font-[600] pt-[30px] text-[#7E7E7E] items-center ">
            ...
            <div className=" ml-1">Ibadan Electric Payment-IBEDC Meter Instantly</div>
            <div><img className="lg:w-[24px]" src={arrow} alt="" /></div>

          </div>
          <div className="lg:flex lg:items-start ">
            <div className={` mt-[12px] lg:mt-[15px] border-[1px] border-[] from-[#E2F3FF] font-[700] text-[10px] lg:text-[16px] lg:rounded-sm lg:py-2 text-center lg:px-3 py-1 to-[#FFF]
             ${
              isDarkMode
                ? "text-white bg-black border border-white"
                : "bg-gradient-to-b"
            }`}>Ibadan Electric Covers: Oyo | Ogun | Osun | Kwara | Parts of: Niger, Ekiti and Kogi States.
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
            <div className=" flex flex-col mt-[20px] gap-1">
              ...
              {showProductList && (
                <div className={`border md:rounded-[12px] text-[10px] md:text-[12px] lg:text-[16px] mt-20 lg:mt-20 w-[90%] md:w-[44%]  rounded-[4px] absolute z-[10]
                ${
                  isDarkMode
                  ? "text-white bg-black border border-white"
                  : "text-[#FFF]"
            ...
            <div className="flex flex-col mt-[10px] md:mt-[23px] lg:mt-[23px]">
              ...
              <div>
                <input type="number" value={meterNumber} onChange={handleMeterNumber} className={`w-full pl-[9px] lg:h-[51px] lg:text-[16px]  text-[14px] font-[500]  border-[1px] h-[40.927px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[20px]  md:p-0 text-[13px] p-4 sm:p-3 sm:text-lg ${
                  isDarkMode
                  ? "text-white bg-black border border-white"
                  : "text-[#7C7C7C]"
              }`}/>{" "}
            ...
            <div className=" flex flex-col mt-[20px] gap-1">
              ...
              {globalTransferErrors.country && (
                <div className={`text-[15px] text-red-500 italic lg:text-[14px]
                   ${
                  isDarkMode
                  ? "text-white bg-black border border-white"
                  : ""
        ...
        <Modal>
          ...
          >
            ...
            <div className="flex w-[70%] mx-auto items-center my-6  gap-[6%] md:gap-[20px] justify-center md:w-[20%] lg:my-[5%]">
              ...
              <Link to="/ibedc-receipt-failed" state={{
                selectedNetworkProduct: selectedNetworkProduct,
                meterNumber: meterNumber,
                phoneNumber: phoneNumber,
                ikedcEmail: ikedcEmail,
