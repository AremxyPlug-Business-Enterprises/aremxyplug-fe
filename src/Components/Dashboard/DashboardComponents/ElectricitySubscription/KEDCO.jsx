    ...
    <DashBoardLayout>
      <div className={` ${isDarkMode
        ...
        <div>
          ...
          <div className=" flex lg:mt-[20px] text-[14px] lg:text-[16px] font-[600] pt-[30px] text-[#7E7E7E] items-center ">
            <div>Recharge</div>
            <div><img className="w-[35px] lg:w-[130px] ml-1" src={logo} alt="" /></div>
            <div className=" ml-1">KEDCO-Kano Electric Meter Instantly</div>
            <div><img className="lg:w-[24px]" src={arrow} alt="" /></div>

          </div>
          <div className="lg:flex lg:items-start ">
            <div className="bg-gradient-to-b mt-[10px] lg:mt-[15px] border-[1px] border-[] from-[#E2F3FF] font-[700] text-[10px] lg:text-[16px] lg:rounded-sm lg:py-2 text-center lg:px-3 py-1 to-[#FFF]">Kano Electric Covers: Kano State | Katsina State | Jigawa State.
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
            ...
            <div className="flex flex-col mt-[10px] md:mt-[23px] lg:mt-[23px]">
              <div className="text-[#7E7E7E] text-[15px] lg:text-[16px] font-[600] " >Meter Number</div>
              <div>
            ...
            <div className=" flex flex-col mt-[20px] gap-1">
              ...
              <div
                className=" border-[1px] w-full h-[40.927px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[8px]  md:p-0 text-xl p-4 sm:p-3 sm:text-lg   pl-[4px] pr-[8px] lg:h-[51px] lg:pl-[14px] lg:pr-[16px] flex items-center justify-between"
        ...
        <Modal>
          ...
          >
            ...
            <div className="flex w-[70%] mx-auto items-center my-6  gap-[6%] md:gap-[20px] justify-center md:w-[20%] lg:my-[5%]">
              ...
              <Link to="/kedco-receipt-failed" state={{
                selectedNetworkProduct: selectedNetworkProduct,
                meterNumber: meterNumber,
                phoneNumber: phoneNumber,
                ikedcEmail: ikedcEmail,
