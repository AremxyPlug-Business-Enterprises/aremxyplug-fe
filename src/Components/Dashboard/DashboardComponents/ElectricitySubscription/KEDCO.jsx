        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
              ...
              {showProductList && (
                <div className={`border md:rounded-[10px] text-[10px] md:text-[12px] lg:text-[16px] mt-20 lg:mt-20 w-[90%] md:w-[44%]  rounded-[4px] absolute  z-[10]
                  ...
                  {productList.map((item) => (
                    <div
                      key={item.name}
                      className={`pb-[18px] md:pb-[14px] pt-[18px] md:pt-[14px] font-weight-bold text-[13.5px] cursor-pointer border-b-[0.5px] text-[#7C7C7C] md:text-[12px] lg:text-[16px] w-[100%]  md:rounded-[0px] lg:mt-2 py-[4px] text-[10px] pl-[5px] 
                         ${
                  isDarkMode
                    ? "text-white bg-black"
                    : "bg-white"
            ...
            <div className="flex flex-col mt-[10px]">
              <div className="text-[#7E7E7E] text-[14px] lg:text-[16px] md:font-[600] font-[400]" >Verified Name</div>
              <div>
            ...
            <div className="flex flex-col mt-[10px]">
              ...
              <div className={`flex items-center lg:text-[16px]  text-[10px] pl-2 border-[1px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[8px]  md:p-0 text-[14px] p-4 sm:p-3 sm:text-lg  ${
              isDarkMode
                ? "text-white bg-black border border-white"
                : "text-[#7E7E7E]"
            }`}>
            ...
            <div className=" flex flex-col mt-[20px] gap-1">
              ...
              <div
                className={`border-[1px] w-full h-[40.927px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[8px]  md:p-0 text-[14px] p-4 sm:p-3 sm:text-lg   pl-[4px] pr-[8px] lg:h-[51px] lg:pl-[14px] lg:pr-[16px] flex items-center justify-between  ${
              ...
              {showList && (
                ...
                >
                  ...
                  {countryList.map((country) => (
                    <div
                      className={`pb-[18px] md:pb-[14px] pt-[18px] md:pt-[14px] font-weight-bold text-[14px] cursor-pointer border-b flex items-center p-2 gap-[5px] text-[11px]  md:text-[14px] lg:text-[16px]
                        ${
                          isDarkMode
                            ? "text-white bg-black border border-white"
                            : ""
