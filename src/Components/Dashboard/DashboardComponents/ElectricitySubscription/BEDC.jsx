        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
            <div className=" flex flex-col mt-[20px] gap-1">
              <div className="text-[#7E7E7E] text-[14px] lg:text-[16px]  md:font-[600] font-[400]">Select Meter Type</div>
              <div
              ...
              {showProductList && (
                <div className={`border md:rounded-[10px] text-[14px] md:text-[11px] lg:text-[16px] mt-20 lg:mt-20 w-[90%] md:w-[44%]  rounded-[4px] absolute  z-[10]
                  ${
                    isDarkMode
                      ? "bg-black text-white"
                      : "bg-[#FFF] "
                  ...
                  {productList.map((item) => (
                    <div
                      key={item.name}
                      className={`pb-[18px] md:pb-[14px] pt-[18px] md:pt-[14px] font-[400] text-[14px] cursor-pointer border-b-[0.5px]  md:text-[11px] lg:text-[16px] w-[100%]  md:rounded-[0px] lg:mt-2 py-[4px] text-[13px] pl-[5px] 
                        ${
                          isDarkMode
                            ? "bg-black text-white border border-white"
            ...
            <div className="flex flex-col mt-[10px]">
              ...
              <div>
                <input type="text" value={verifiedName} onChange={handleVerifiedName} className={`w-full lg:h-[51px] lg:text-[16px]  text-[14px] pl-[9px] font-[500]  border-[1px] h-[40.927px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[20px]  md:p-0 text-[13px] p-4 sm:p-3 sm:text-lg  ${
            ...
            <div className="flex flex-col mt-[10px]">
              ...
              <div>
                <input type="number" value={phoneNumber} onChange={handlePhoneNumber} className={`w-full lg:h-[51px] lg:text-[16px]  pl-[9px] text-[14px] font-[500]  border-[1px] h-[40.927px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[20px]  md:p-0 text-[13px] p-4 sm:p-3 sm:text-lg  ${
              isDarkMode
                ? "bg-black text-white border border-white"
                : "text-[#7E7E7E]"
            }`} />
            ...
            <div className="flex flex-col mt-[10px]">
              ...
              <div>
                <input type="text" value={ikedcEmail} onChange={handleEmail} className={`w-full lg:h-[51px] pl-[9px] lg:text-[16px] text-[14px] font-[500]  border-[1px] h-[40.927px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[20px]  md:p-0 text-[13px] p-4 sm:p-3 sm:text-lg  ${
              isDarkMode
                ? "bg-black text-white border border-white"
                : "text-[#7E7E7E]"
            }`} />
            ...
            <div className="flex flex-col mt-[10px]">
              ...
              isDarkMode
                ...
                &#8358;
                <input type="number" name="ikedcamount" value={ikedcamount} onChange={handleIkedcAmount} className={`w-full outline-none lg:h-[51px] lg:text-[16px] pl-[9px] text-[13px] font-[500]  h-[40.927px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[8px]  md:p-0 text-[13px] p-4 sm:p-3 sm:text-lg 
                ${
                  isDarkMode
              ...
              >
                ...
                {selected ? (
                  <div className={`flex w-[100%] justify-between items-center
                    ...
                    <p className={`text-[14px] font-extrabold lg:text-[14px]
                    ${
                      isDarkMode
                        ? "bg-black text-white"
                        : "text-[#7E7E7E]"
              ...
              {showList && (
                ...
                >
                  ...
                  {countryList.map((country) => (
                    <div
                      className={`pb-[18px] md:pb-[14px] pt-[18px] md:pt-[14px] md:font-[600] font-[400] text-[13px] cursor-pointer border-b flex items-center p-2 gap-[5px] text-[11px]  md:text-[14px] lg:text-[16px]
                          ${
                  isDarkMode
                  ? "text-white bg-black border border-white"
                  : ""
