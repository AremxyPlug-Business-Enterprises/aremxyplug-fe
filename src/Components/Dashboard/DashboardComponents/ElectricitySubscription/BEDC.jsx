              ...
              {showProductList && (
                <div className="border md:rounded-[10px] text-[14px] md:text-[11px] lg:text-[16px] mt-20 lg:mt-20 w-[90%] md:w-[44%]  rounded-[4px] absolute  bg-[#FFF] z-[10]">
                  {productList.map((item) => (
                    <div
                      key={item.name}
                      className={`pb-[18px] md:pb-[14px] pt-[18px] md:pt-[14px] font-[400] text-[14px] cursor-pointer border-b-[0.5px] text-[#7C7C7C] md:text-[11px] lg:text-[16px] w-[100%]  md:rounded-[0px] lg:mt-2 py-[4px] text-[13px] pl-[5px] ${selectedNetworkProduct === item.name ? "bg-white" : ""
                        }`}
