      ...
      <div className={` ${isDarkMode
        ...
        <div>
          ...
          <div className="lg:flex lg:items-start ">
            <div className="bg-gradient-to-b mt-[10px] lg:mt-[15px] border-[1px] border-[] from-[#E2F3FF] font-[700] text-[10px] lg:text-[16px] lg:rounded-sm lg:py-2 text-center lg:px-3 py-1 to-[#FFF]">Benin Electric Covers: Delta, Edo, Ekiti, and Ondo States.
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
              ...
              {showProductList && (
                <div className="border md:rounded-[10px] text-[14px] md:text-[11px] lg:text-[16px] mt-20 lg:mt-20 w-[90%] md:w-[44%]  rounded-[4px] absolute  bg-[#FFF] z-[10]">
                  {productList.map((item) => (
                    <div
                      key={item.name}
                      className={`pb-[14px] md:pb-0 pt-[14px] md:pt-0 font-weight-bold text-[14px] cursor-pointer border-b-[0.5px] text-[#7C7C7C] md:text-[11px] lg:text-[16px] w-[100%]  md:rounded-[0px] lg:mt-2 py-[4px] text-[11px] pl-[5px] ${selectedNetworkProduct === item.name ? "bg-white" : ""
                        }`}
            ...
            <div className="flex flex-col mt-[10px]">
              <div className="text-[#7E7E7E] text-[14px] lg:text-[16px] font-[600]" >Verified Name</div>
              <div>
            ...
            <div className="flex flex-col mt-[10px]">
              <div className="text-[#7E7E7E] text-[14px] lg:text-[16px]   font-[600]" >Email</div>
              <div>
            ...
            <div className=" flex flex-col mt-[20px] gap-1">
              <div className="text-[#7E7E7E] text-[14px] lg:text-[16px]  font-[600]">Payment Method</div>
              <div
                className=" border-[1px] w-full h-[40.927px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[20px]  md:p-0 text-xl p-4 sm:p-3 sm:text-lg   pl-[4px] pr-[8px] lg:h-[51px] lg:pl-[14px] lg:pr-[16px] flex items-center justify-between"
