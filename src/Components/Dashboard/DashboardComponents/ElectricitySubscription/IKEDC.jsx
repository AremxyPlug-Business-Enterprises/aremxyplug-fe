...
const IKEDC = () => {
  ...
  function handleReceivedData() {
    ...
    const receivedData = () => {
      ...
      setIkedcShowDescription(ikedcFetchedResponse?.data?.transaction_description);
      setIkedcDiscoType(ikedcFetchedResponse?.data?.disco_type);
      setIkedcVerifiedName(ikedcFetchedResponse?.data?.verified_name);
      setIkedcFullName(ikedcFetchedResponse?.data?.full_name);
      setIkedcTransactionProduct(ikedcFetchedResponse?.data?.transaction_product);
    };
    receivedData();
    if (receivedData) {
      ...
      >
        <div>
          ...
          <div className="lg:flex lg:items-start ">
            <div
              className={`mt-[10px] lg:mt-[15px] border font-bold text-[10px] lg:text-[16px] lg:rounded-sm lg:py-2 text-center lg:px-3 py-1 
         ${
           isDarkMode
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
            ...
            <div className="flex flex-col relative gap-2 lg:gap-2.5">
              ...
              {amountError && (
                <p className="text-[14px] text-red-500 italic lg:text-[14px] absolute left-0 -bottom-[1.3rem]">
                  {amountError}
                </p>
              )}
            </div>
        ...
        <footer className="flex justify-center items-center text-center gap-[18px] mt-[200px] pb-[10%] md:mt-[750px] lg:mt-[850px]">
          ...
          <Link to="/ContactUs">
            <div
              ...
              } text-[11px] px-2 py-1 text-white rounded-[8px] lg:text-[16px]`}
            >
              Contact Us
            </div>
          </Link>
        ...
        <Modal>
          ...
          >
            ...
            >
              ...
              >
                {selectedIkedcMeterType} Meter (&#8358;{Number(ikedcAmount).toLocaleString()}){" "}
              </span>
              {/* Points to <br></br>
