      ...
      <div className={` ${isDarkMode
        ...
        <div>
          ...
          <div className="lg:flex lg:items-start ">
            <div className="bg-gradient-to-b mt-[10px] lg:mt-[15px] border-[1px] border-[] from-[#E2F3FF] font-[700] text-[10px] lg:text-[16px] lg:rounded-sm lg:py-2 text-center lg:px-3 py-1 to-[#FFF]">Ikeja Electric Covers: Ikeja IKEDC.
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
              ...
              {showProductList && (
                <div className="border md:rounded-[10px] text-[14px] md:text-[12px] lg:text-[16px] mt-20 lg:mt-20 w-[90%] md:w-[44%]  rounded-[4px] absolute  bg-[#FFF] z-[10]">
                  {productList.map((item) => (
                    <div
                      key={item.name}
                      className={`pb-[18px] md:pb-[14px] pt-[18px] md:pt-[14px] font-weight-bold text-[15px] cursor-pointer border-b-[0.5px] text-[#7C7C7C] md:text-[12px] lg:text-[16px] w-[100%]  md:rounded-[0px] lg:mt-2 py-[4px] text-[10px] pl-[5px] ${selectedNetworkProduct === item.name ? "bg-white" : ""
                        }`}
            ...
            <div className="flex flex-col mt-[10px]">
              ...
              <div>
                <input type="text" value={verifiedName} onChange={handleVerifiedName} className=" w-full text-[#7E7E7E] lg:h-[51px] lg:text-[16px]  text-[10px] pl-[9px] font-[500]  border-[1px] h-[40.927px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[20px]  md:p-0 text-[13px] p-4 sm:p-3 sm:text-lg " />{" "}
              </div>
            </div>
            <div className="flex flex-col mt-[10px]">
              <div className="text-[#7E7E7E] text-[15px] lg:text-[16px] md:font-[600] font-[400]" >Phone Number</div>
              <div>
                <input type="number" value={phoneNumber} onChange={handlePhoneNumber} className=" w-full text-[#7E7E7E] lg:h-[51px] lg:text-[16px]  pl-[9px] text-[10px] font-[500]  border-[1px] h-[40.927px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[20px]  md:p-0 text-[13px] p-4 sm:p-3 sm:text-lg " />
              </div>
              {errors.phoneNumber && (
                <div className="text-[14px] text-red-500 italic lg:text-[14px]">
                  {errors.phoneNumber}
            ...
            <div className="flex flex-col mt-[10px]">
              ...
              <div className="flex items-center lg:text-[16px] text-[#7E7E7E] text-[11px] pl-2 border-[1px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[8px]  md:p-0 text-[13px] p-4 sm:p-3 sm:text-lg">
                &#8358;
                <input type="number" name="ikedcamount" value={ikedcamount} onChange={handleIkedcAmount} className=" w-full outline-none lg:h-[51px] lg:text-[16px]  text-[#7E7E7E] pl-[9px] text-[14px] font-[500]   h-[30px] " />
              </div>
            </div>
              ...
              >
                ...
                {selected ? (
                  <div className="flex w-[100%] justify-between items-center">
                    ...
                    <p className="text-[13px] text-[#7E7E7E] font-extrabold lg:text-[14px]">
                      {" "}
                      {globalCountry}
                    </p>
                    <img
