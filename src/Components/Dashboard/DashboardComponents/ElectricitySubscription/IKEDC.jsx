...
const IKEDC = () => {
 ...
 const GetBalance = async () => {
  ...
  const handleCountryClick = (name, flag, id, code, balance) => {
    ...
    setSelected(true);
    setIkedcWalletBalance(balance);
    setIkedcPaymentResult(`${name} ${balance}`);
    // setCountryCode(code);
  ...
  const verifyPin = async () => {
    async function ElectricityHandler() {
      ...
      const SuccessHandler = (response) => {
        ...
        setIkedcDiscoType(response?.data?.data?.data?.disco_type);
    ...
    md:pr-[5.282px] md:pl-[5.867px] lg:pt-[15px] lg:pb-[12px] lg:pr-[9px] lg:pl-[10px]  items-center cursor-pointer outline-0 border-[0.24px] lg:border-[0.4px] w-full h-[45.927px] md:h-[35px] lg:h-[50px] border-[#9C9C9C] px-[11px] md:px-[6px] lg:px-[10px] text-[#7C7C7C] self-center  ${
      isDarkMode
        ...
        : "hover:bg-[#EDEAEA]"
            ...
            {/* Container for Email and Amount */}
            <div className="w-full flex flex-col md:flex-row gap-5 md:gap-3 lg:gap-[22px] md:my-2 lg:my-4">
              {/* Leftside */}
        ...
        : "hover:bg-[#EDEAEA]"
                ...
                >
                  ...
                  <input
                    ...
                    className={`w-full ml-0.5 placeholder:text-base outline-none
                      placeholder:leading-[10.4px] placeholder:lg:text-base
                       placeholder:lg:leading-[20.8px] focus:outline-none ${
                      isDarkMode ? "bg-black" : ""
                    }
                 `}
                  />
            ...
            <div className="w-full flex flex-col md:flex-row gap-5 md:gap-3 lg:gap-[22px] md:my-2 lg:my-4">
              <div className="flex flex-col gap-[3px] relative lg:gap-[5px] w-full md:w-1/2">
                <label
                  className={` text-sm md:text-[13px] lg:text-base md:font-semibold font-normal ${
                    isDarkMode ? "text-white" : "text-black"
                  }`}
              ...
              <span className="text-[#000] font-extrabold text-[10px] md:text-base lg:text-xs">
                ...
                <div className="flex flex-col gap-3 mt-5 md:mt-6 lg:mt-7">
                  ...
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between font-medium items-center lg:text-base">
                    ...
                    <span>
                      {ikedcAmount
                        ? `₦${Number(ikedcAmount).toLocaleString()}.00`
                        : "₦"}
                    </span>
                  </div>
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between font-medium items-center lg:text-base">
                    ...
                    <span>Nigerian {ikedcPaymentResult.split(" (")[0]}</span>
                  </div>
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between font-medium items-center lg:text-base">
                    <p
                      className={` ${
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex gap-[10px] justify-center items-center">
                    ...
                    <div className="flex gap-[10px] items-center font-medium">
                      ...
                      >
                        {ikedcWalletBalance !== "" ? ikedcWalletBalance : "₦"}
                      </span>
                    </div>
                  </div>
                ...
                <div className="flex mt-4 flex-col gap-2 lg:gap-4">
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between items-center lg:text-[15px] font-medium">
                    ...
                    <div className="flex items-center gap-1 ">
                      ...
                      <span className="capitalize">{ikedcDiscoType}</span>
                    </div>
                  </div>
