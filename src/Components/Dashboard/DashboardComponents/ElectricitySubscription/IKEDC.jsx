        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
            <div className=" flex flex-col mt-[20px] gap-1">
              ...
              >
                <h2 className="text-[13px] font-[600]  leading-[12px] text-[#7C7C7C] capitalize md:text-[9.17px] md:leading-[11.92px] lg:text-[16px] lg:leading-[24px]">
                  {selectedNetworkProduct}
                </h2>
              ...
              {showProductList && (
                <div className="border md:rounded-[10px] text-[14px] md:text-[12px] lg:text-[16px] mt-20 lg:mt-20 w-[90%] md:w-[44%]  rounded-[4px] absolute  bg-[#FFF] z-[10]">
                  {productList.map((item) => (
                    <div
                      key={item.name}
                      className={`pb-[14px] md:pb-0 pt-[14px] md:pt-0 font-weight-bold text-[15px] cursor-pointer border-b-[0.5px] text-[#7C7C7C] md:text-[12px] lg:text-[16px] w-[100%]  md:rounded-[0px] lg:mt-2 py-[4px] text-[10px] pl-[5px] ${selectedNetworkProduct === item.name ? "bg-white" : ""
                        }`}
            ...
            <div className="flex flex-col mt-[10px]">
              <div className="text-[#7E7E7E] text-[14px] lg:text-[16px]  font-[600]" >Amount</div>
              <div className="flex items-center lg:text-[16px] text-[#7E7E7E] text-[11px] pl-2 border-[1px] mt-2 md:mt-0 rounded-[10px] md:rounded-0 p-[8px]  md:p-0 text-xl p-4 sm:p-3 sm:text-lg">
                &#8358;
              ...
              {showList && (
                ...
                >
                  ...
                  {countryList.map((country) => (
                    <div
                      className="pb-[14px] md:pb-0 pt-[14px] md:pt-0 font-weight-bold text-[14px] cursor-pointer border-b flex items-center p-2 gap-[5px] text-[11px]  md:text-[14px] lg:text-[16px]"
                      key={country.id}
                      onClick={() =>
                        handleCountryClick(
                          country.name,
