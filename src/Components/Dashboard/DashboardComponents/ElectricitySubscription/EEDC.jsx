      ...
      <div className={` ${isDarkMode
        ...
        <div>
            ...
            <div className={` mt-[10px] lg:mt-[15px] border-[1px] border-[] from-[#E2F3FF] font-[700] text-[10px] lg:text-[16px] lg:rounded-sm lg:py-2 text-center lg:px-3 py-1 to-[#FFF]
             ${
              isDarkMode
                ...
                : "bg-gradient-to-b"
            }`}>Enugu Electric Covers: Enugu State | Imo State | Abia State | Anambra State | Eboyin State.
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-6 lg:gap-6 items-center lg:mt-[20px] ">
            ...
            <div className="flex flex-col mt-[12px] md:mt-[23px] lg:mt-[23px]">
              ...
              isDarkMode
                ...
                >
                  ...
                  {countryList.map((country) => (
                    <div
                      className={`pb-[18px] md:pb-[14px] pt-[18px] md:pt-[14px] font-weight-bold text-[13px] cursor-pointer border-b flex items-center p-2 gap-[5px] text-[11px]  md:text-[14px] lg:text-[16px]
                              ${
              isDarkMode
                ? "text-white bg-black"
                : ""
        ...
        <footer className="flex justify-center text-center gap-[20px] mt-[200px] pb-[10%] md:mt-[750px]  lg:mt-[850px]">
          <p className="text-[10px] md:text-[12px] lg:text-[20px]  font-[500] leading-[9.1px] mt-[5px] lg:mt-[13px]">
            You need help?
          </p>
