...
const GetBalance = async () => {
  ...
  const handleCountryClick = (name, flag, id, code, balance) => {
    ...
    setEedcCountry(name);
    setSelected(true);
    setEedcWalletBalance(balance);
    setEedcPaymentResult(`${name} ${balance}`);
    // setCountryCode(code);
        ...
        : "hover:bg-[#EDEAEA]"
              ...
              <div className="relative flex flex-col gap-[3px] lg:gap-[5px] w-full md:w-1/2 ">
                ...
                <input
                  ...
                  onChange={(e)=> {
                    setEedcMeterNumber(e.target.value);
                    if(timer.current) clearTimeout(timer.current)   
                timer.current = setTimeout(()=> {
              //Run every 5 seconds
                handleEedcMeterNumber(e)
      ...
      isDarkMode
        ...
        : "hover:bg-[#EDEAEA]"
                ...
                {errors.eedcPhoneNumber && (
                  <div className="text-[14px] absolute left-0 -bottom-4 sm:-bottom-[1.5rem] leading-3 text-red-500 italic lg:text-[14px]">
                    {errors.eedcPhoneNumber}
                  </div>
                )}
              </div>
                ...
                >
                  ...
                  <input
                    ...
                    className={`w-full ml-0.5 placeholder:text-base outline-none 
                      placeholder:leading-[10.4px] placeholder:lg:text-base placeholder:lg:leading-[20.8px] focus:outline-0 outline-0 ${
                      isDarkMode ? "bg-black" : ""
                    }`}
                  />
                </div>
            ...
            >
              ...
              <span className="text-[#000] font-extrabold text-[10px] md:text-[16px] lg:text-xs">
                &#8358;{}
                  ...
                  from your {eedcPaymentResult.split(" (")[0]} to
                </p>
                ...
                <div className="flex flex-col gap-3 mt-5 md:mt-6 lg:mt-7">
                  ...
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between font-medium items-center lg:text-base">
                    ...
                    <span>
                      {eedcAmount
                        ? `₦${Number(eedcAmount).toLocaleString()}.00`
                        : "₦"}
                    </span>
                  </div>
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between font-medium items-center lg:text-base">
                    ...
                    <span>Nigerian {eedcPaymentResult.split(" (")[0]}</span>
                  </div>
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between font-medium items-center lg:text-base">
                    <p
                      className={` ${
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex gap-[10px] justify-center items-center">
                    ...
                    <div className="flex gap-[10px] items-center font-medium">
                      ...
                      >
                        {eedcWalletBalance !== "" ? eedcWalletBalance : "₦"}
                      </span>
                    </div>
                  </div>
                ...
                <div className="flex mt-4 flex-col gap-2 lg:gap-4">
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between items-center lg:text-[15px] font-medium">
                    ...
                    <div className="flex items-center gap-1 ">
                      ...
                      <span className="capitalize">{eedcDiscoType}</span>
                    </div>
                  </div>
