              ...
              {showList && (
                ...
                >
                  ...
                  {countryList.map((country) => (
                    <div
                      className="pb-[18px] md:pb-0 pt-[18px] md:pt-0 font-weight-bold text-[13px] cursor-pointer border-b flex items-center p-2 gap-[5px] text-[11px]  md:text-[14px] lg:text-[16px]"
                      key={country.id}
                      onClick={() =>
                        handleCountryClick(
                          country.name,
