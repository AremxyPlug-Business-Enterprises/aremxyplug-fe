...
const ElectricitySubscription = () => {
    ...
    return ( 
      ...
      <div className={` ${toggleSideBar ? "lg:gap-[97px] md:gap-[27px]" : "lg:gap-[180px] md:gap-[70px]"} grid grid-cols-2  md:grid-cols-5 pt-[20px] w-full lg:mt-[70px]  gap-8   lg:leading-[19px] text-[#000000]`}>
            <Link to= "/ikedc"  >
