...
const ElectricitySubscription = () => {
    ...
    return ( 
      ...
      <div className={` ${toggleSideBar ? "lg:gap-[88px] md:gap-[27px]" : "lg:gap-[130px] md:gap-[70px]"} grid grid-cols-2  md:grid-cols-5 pt-[20px] lg:mt-[70px]  gap-8   lg:leading-[19px] text-[#000000]`}>
            <Link to= "/ikedc"  >
