...
const ElectricitySubscription = () => {
    ...
    return ( 
      ...
      <div className={ ` ${toggleSideBar ?   " alignwidth md:gap-5 lg:gap-10 " : "alignwidth1 md:gap-10 lg:gap-20 xl:gap-[100px]"   } mt-[20px] flex flex-wrap w-full justify-between lg:mt-[70px] gap-6  ` }> 
            <Link to= "/ikedc"  >
