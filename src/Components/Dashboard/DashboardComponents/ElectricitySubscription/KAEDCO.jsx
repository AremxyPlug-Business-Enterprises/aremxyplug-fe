...
const GetBalance = async () => {
  ...
  const handleProceed = (e) => {
    ...
    const amount = Number(kaedcoAmount);
    // validating the network numbers
    const network = validateNigerianNumberByNetwork(kaedcoPhoneNumber);
    if (error) {
      setErrors(
  ...
  const handleCountryClick = (name, flag, id, code, balance) => {
    ...
    setSelected(true);
    setKaedcoWalletBalance(balance);
    setKaedcoPaymentResult(`${name} ${balance}`);
    // setCountryCode(code);
...
let passedMeterName;
  ...
  function handleFailedData() {
    ...
    handleReceivedData();
    navigate("/kaedco-receipt-failed");
    // setLoading(false);
  }
  ...
  let aedcAmountToNumber = Number(kaedcoAmount);
      ...
      >
        <div>
          ...
          >
            ...
            <div className=" ml-1">
              <img className="w-3.5 lg:w-[24px]" src={arrow} alt="" />
            </div>
          </div>
            ...
            >
              ...
              <span className="text-[#000] font-extrabold text-[10px] md:text-base lg:text-xs">
                &#8358;{}
                  ...
                  from your {kaedcoPaymentResult.split(" (")[0]} to
                </p>
                ...
                <div className="flex flex-col gap-3 mt-5 md:mt-6 lg:mt-7">
                  ...
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between font-medium items-center lg:text-base">
                    ...
                    <span>
                      {kaedcoAmount
                        ? `₦${Number(kaedcoAmount).toLocaleString()}.00`
                        : "₦"}
                    </span>
                  </div>
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between font-medium items-center lg:text-base">
                    ...
                    <span>Nigerian {kaedcoPaymentResult.split(" (")[0]}</span>
                  </div>
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between font-medium items-center lg:text-base">
                    <p
                      className={` ${
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex gap-[10px] justify-center items-center">
                    ...
                    <div className="flex gap-[10px] items-center font-medium">
                      ...
                      >
                        {kaedcoWalletBalance !== "" ? kaedcoWalletBalance : "₦"}
                      </span>
                    </div>
                  </div>
                ...
                <div className="flex mt-4 flex-col gap-2 lg:gap-4">
                  <div className="flex text-[10px] md:text-sm w-[90%] mx-auto justify-between items-center lg:text-[15px] font-medium">
                    ...
                    <div className="flex items-center gap-1 ">
                      ...
                      <span className="capitalize">{kaedcoDiscoType}</span>
                    </div>
                  </div>
