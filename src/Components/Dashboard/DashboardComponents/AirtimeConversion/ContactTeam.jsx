        ...
        <div>
          ...
          <div className="text-[10px] md:text-[12px] lg:text-[16px] flex flex-col gap-2 items-center md:items-start">
            <div className="font-[600]">
              The team incharge will reach out to you as soon as possible.
            </div>
            <div>
              Verified Email:{" "}
              <span className="text-[#04177F] font-[600]">
                airtimeconversion@aremxyplug.com
              </span>
            </div>
            <div>
              Completion Time 0 - 2 hours, from 09:00am - 10:00pm UTC+1.
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 mt-4 md:mt-6 gap-5">
            <div>
              ...
              <div className="border w-full h-[30px] rounded-[4px] pr-[8px] pl-[4px] lg:h-[51px] md:rounded-[6px] lg:rounded-[10px] lg:pl-[14px] lg:pr-[16px] flex items-center justify-between">
                <input
                  type="text"
                  className="lg:text-[16px] lg:leading-[24px] grow outline-none text-[8px] font-bold leading-[12px]"
            ...
            <div>
              <div className="lg:text-[16px] lg:leading-[24px] items-center flex gap-2 mb-1 text-[8px] leading-[12px]">
                <div className="font-bold">Amount to Receive </div>
              </div>
              <div className="border w-full h-[30px] rounded-[4px] pr-[8px] pl-[4px] lg:h-[51px] md:rounded-[6px] lg:rounded-[10px] lg:pl-[14px] lg:pr-[16px] flex items-center justify-between">
                <input
                  type="text"
          ...
          <div className=" text-[#7C7C7C] text-[8px] lg:text-[12px] flex flex-col gap-2 mt-5 font-[500] items-start md:items-start">
            <div className="flex gap-2 ">
              ...
              />
              <label htmlFor="acknowledgeCheckbox" className="font-semibold">
                I acknowledge that the details I provided above are correct, and
            ...
            <div className="flex gap-2">
              ...
              />
              <label htmlFor="agreementCheckbox" className="font-semibold">
          ...
          <div
            ...
            className={`text-white lg:text-[16px] lg:py-1 w-full md:w-[93px] lg:w-[163px] rounded-md md:py-1 md:rounded-lg md:px-1 py-3 text-center mt-[40px] text-[12px] font-[600] ${
              firstName &&
              lastName &&
              inputValue &&
              airEmail &&
            ...
            disabled={!acknowledgeChecked || !agreementChecked}
          >
            Contact Team
          </div>
        </div>
        ...
        <Modal>
          ...
          >
            ...
            <div className="text-[10px] md:text-[12px]  flex flex-col text-[#4A4A4A] gap-6 items-center text-center">
              <div className="font-[600] text-[#000000]">
                Your request has been sent successfully. <br /> The team
                incharge will reach out to you as soon as possible.
              </div>
              <div>
                Only expect a further email from the Verified Email <br />{" "}
                "airtimeconversion@aremxyplug.com" to complete the Airtime{" "}
                <br /> conversion transaction.
              </div>
              <div>
                Please beware of falling into victim, no AremxyPlug team will{" "}
                <br /> never reach out to you via DM for your transaction PIN,
                or any <br /> personal transaction purpose. <br /> Please
                contact us if you have any further enquiry or need any immediate
                assistance.
              </div>
              <div className="flex flex-col gap-2">
                <div className="text-[#04177F] font-bold">
                  Email Us: support@aremxyplug.com,
                </div>
                <div className="text-[#04177F] font-bold">
                  Phone: +2347066096932.
                </div>
