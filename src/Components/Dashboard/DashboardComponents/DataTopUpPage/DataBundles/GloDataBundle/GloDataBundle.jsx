...
const Balance = newBalance !== null &&
 ...
 : passDataBalance?.data?.data && (newBalance === "" 
  ...
  const handleSelectOption = (plan) => {
    ...
    setSelectedAmountGlo(`${plan?.Amount !== null || plan?.Amount !== undefined
...
const RecipientExistCheck = CheckRecipientInfoInList(recipientPhoneNumberGlo);
  ...
  const handleChange = (e) => {
    ...
    if (numericValue.length === 11) {
      ...
      if (error) {
        setErrors({ recipientPhoneNumberGlo: error });
      } else {
        setErrors({});
      }
    } else {
    ...
    <DashBoardLayout>
      ...
      >
        ...
        >
          ...
          <div className="flex gap-[15px]  justify-between md:w-full md:gap-[10%] mb-10">
    ...
    md:pr-[5.282px] md:pl-[5.867px] lg:pt-[15px] lg:pb-[12px] lg:pr-[9px] lg:pl-[10px]  items-center cursor-pointer outline-0 border-[0.24px] lg:border-[0.4px] w-full h-[45.927px] md:h-[35px] lg:h-[50px] border-[#9C9C9C] px-[11px] md:px-[6px] lg:px-[10px] text-[#7C7C7C] self-center  ${
      isDarkMode
        ...
        : "hover:bg-[#EDEAEA]"
              ...
              >
                <h2 className="text-base font-[400] leading-[20px] capitalize md:text-[9.17px] md:leading-[11.92px] lg:text-[16px] lg:leading-[24px]">
                  {selectedProductGlo}
                </h2>
         ...
         ${
            ...
            The data purchase has been sent successfully to the recipient phone number.
             ...
             balance to confirm the value. You can contact us for any further assistance
                ...
                mx-auto px-[50px] items-center gap-[5%] 
                md:gap-[10%] mt-[50px] md:w-[50%] lg:gap-[10%]
                 lg:mx-auto  lg:my-[5%] md:mt-[40px]">
