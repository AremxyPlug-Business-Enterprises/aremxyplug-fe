   ...
   <div className={`flex justify-between items-center
     mx-[3%] my-[2%] lg:my-[1%]`}>
          ...
          `}>
            ...
            <p lassName={`text-[10px] p-[5.729px] border-[0.573px] rounded-[6.302px]
          ...
          <div className="flex w-[70%] mx-auto mb-[5%] md:w-[60%] ">
            <button
              ...
              className={`bg-[#04177f] w-[111px] flex
                 ...
                 text-[12px] font-extrabold h-[40px]
                  text-white rounded-[6px] md:w-[25%] 
                  md:rounded-[8px] md:text-[16px] lg:w-[163px]
                   lg:h-[38px] lg:my-[2%]`}
            >
              Share Receipt
            </button>
