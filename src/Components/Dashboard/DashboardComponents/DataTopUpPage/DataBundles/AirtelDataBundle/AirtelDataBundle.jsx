  ...
  const productList = [
    {
      ...
      name: "AIRTEL CG",
      options: [
        "AIRTEL CG 100MB (₦100) ~ 1 MONTH",
        "AIRTEL CG 200MB (₦100) ~ 1 MONTH",
        "AIRTEL CG 300MB (₦100) ~ 1 MONTH",
        "AIRTEL CG 1GB (₦100) ~ 1 MONTH",
        "AIRTEL CG 2GB (₦100) ~ 1 MONTH",
        "AIRTEL CG 3GB (₦100) ~ 1 MONTH",
        "AIRTEL CG 5GB (₦100) ~ 1 MONTH",
        "AIRTEL CG 10GB (₦100) ~ 1 MONTH",
        "AIRTEL CG 15GB (₦100) ~ 1 MONTH",
        "AIRTEL CG 20GB (₦100) ~ 1 MONTH",
      ],
    },
    {
      id: 2,
      name: "AIRTEL GIFTING",
      options: [
        "AIRTEL GIFTING 1.5GB (₦100) ~ 1 MONTH",
        "AIRTEL GIFTING 2GB (₦100) ~ 1 MONTH",
        "AIRTEL GIFTING 3GB (₦100) ~ 1 MONTH",
        "AIRTEL GIFTING 4.5GB (₦100) ~ 1 MONTH",
        "AIRTEL GIFTING 6GB (₦100) ~ 1 MONTH",
        "AIRTEL GIFTING 10GB (₦100) ~ 1 MONTH",
        "AIRTEL GIFTING 11GB (₦100) ~ 1 MONTH",
        "AIRTEL GIFTING 15GB (₦100) ~ 1 MONTH",
        "AIRTEL GIFTING 40GB (₦100) ~ 1 MONTH",
        "AIRTEL GIFTING 75GB (₦100) ~ 1 MONTH",
        "AIRTEL GIFTING 120GB (₦100) ~ 1 MONTH",
      ],
    },
