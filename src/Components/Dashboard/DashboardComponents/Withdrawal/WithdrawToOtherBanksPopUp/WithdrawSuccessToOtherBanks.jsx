...
export const WithdrawSuccessToOtherBanks = () => {
  const {
    toggleSideBar,
    transferFee,
    textRef,
  ...
  const handleTransactionSuccessClose = () => {
    setOtherBankWithdrawalSuccess(false);
  };
        ...
        <Modal>
          ...
          >
            <div className="flex justify-between items-center mx-[3%] my-[2%] lg:my-[1%]">
              <img
                onClick={() => setOtherBankWithdrawalSuccess(false)}
            ...
            <div className="flex w-[70%] mx-auto items-center gap-[5%] md:w-[60%] lg:my-[5%]">
              ...
              <Link to="/other-bank-withdrawalreceipt">
                <button
                  onClick={handleTransactionSuccessClose}
