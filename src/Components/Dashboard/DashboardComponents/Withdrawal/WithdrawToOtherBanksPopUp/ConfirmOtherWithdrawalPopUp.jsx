...
export const ConfirmOtherWithdrawalPopUp = () => {
  ...
  const handleSwitch = () => {
    setWithdrawalInputPin(true);
    setOtherWithdrawalConfirmation(false);
  };
  return (
    <div>
      {otherWithdrawalConfirmation && (
        <Modal>
          ...
          >
            <img
              onClick={() => setOtherWithdrawalConfirmation(false)}
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex text-[10px] md:text-[14px] w-[90%] mx-auto justify-between  lg:text-[16px]">
                <p className="text-[#0008]">Amount to Withdraw</p>
                <span>&#8358;{amtToWithdraw}.00</span>
              </div>
              <div className="flex text-[10px] md:text-[14px] w-[90%] mx-auto justify-between  lg:text-[16px]">
              ...
              <div className="flex text-[10px] md:text-[14px] w-[90%] mx-auto justify-between  lg:text-[16px]">
                ...
                <span>&#8358;{totalAmount(amtToWithdraw, transferFee)}.00</span>
              </div>
              <div className="flex text-[10px] md:text-[14px] w-[90%] mx-auto justify-between  lg:text-[16px]">
