        ...
        >
          <div className="flex items-center">
            ...
            <div className="lg:ml-[10px] md:ml-[7px] ml-[4px]">
              ...
              <p
                className={`${
                  isDarkMode ? "text-[#fff]" : "text-[#7c7c7c]"
        ...
        <div>
          ...
          <div className="w-full h-[90px] md:h-[112.29px] lg:h-[196px] rounded-[7px] md:rounded-[11.5px] flex px-[16px] lg:px-[50px] justify-between items-center lg:rounded-[20px] backgroundImage">
            <div className="py-[13px] lg:py-[40px] flex flex-col justify-center h-full pr-[25px] md:pr-[50px] lg:pr-[75px]">
              <div>
                <h2 className="text-[10px] md:text-[13.75px] font-bold mb-3 lg:text-[24px] lg:mb-4">
                  ENJOY QUICK AND SECURE PAYMENT PROCESSING.
                </h2>
                <h2 className="text-[7px] md:text-[11.46px] lg:text-[20px] lg:leading-[26px]">
                  To make sure your transactions go off without a hitch, using
                  our user-friendly interface to receive money both locally and
                  internationally.
                </h2>
              </div>
            </div>
            <div className="h-[80px] lg:h-[170px] flex items-center justify-end overflow-hidden lg:justify-end">
              <img
                src="./Images/paymentPage/paymentBanner.png"
                alt=""
                className="h-full -mb-4 -mr-2"
              />
            </div>
          </div>
          ...
          <div className="mt-[25.39px] md:mt-[35px] lg:mt-[60px] ">
            <div className="flex items-center">
              <p className=" text-[#7c7c7c] text-[10px]  md:text-[18px] lg:text-[20px]">
                Select Payment Type
              </p>
              <img
                src="Images/top_up/arrowR.png"
          ...
          <div className="mt-[25.39px] md:mt-[35px] lg:mt-[60px]">
            {cardPaymentData.map((d, index) => (
              <Element isDarkMode={isDarkMode} data={d} key={index} />
            ))}
          </div>
        </div>
        {showPopUp && (
