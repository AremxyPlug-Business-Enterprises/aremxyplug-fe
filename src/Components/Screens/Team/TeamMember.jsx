...
const TeamMember = ({memberData: {name, 
  ...
  return (
    <div 
    className={`relative w-full border-[4px] h-[467.36px] 
      md:h-[408.8px] flex flex-col justify-end 
    lg:h-[728px] rounded-t-[64.19px] rounded-b-[6px] pt-[10px]
     border-[#d4d1d1] lg:border-[7px] my-[20px]`}>
      <div className ="absolute top-[10%] w-full
         flex justify-center
       z-[1]">
   <img className="rounded-full h-[200px]
       w-[200px] lg:w-[300px] lg:h-[300px] object-center" 
    src={image} alt="" />
    </div>
    <div className='flex flex-col justify-end items-center
    pt-[50.2px] bg-[#eeebeb]  h-[55%]
        md:pt-[36.5px] lg:pt-[83px]'>
      <h2 className='text-left mb-[10px] text-primary font-bold lg:mb-[19px] 
        ...
        <p className='mx-[18px] mb-[40.2px] lg:mb-[61px] text-justify md:mb-[33.6px] text-[12px] leading-[18px] md:text-[11px] md:leading-[16.5px] 
        lg:text-[20px] lg:leading-[30px]'>
          {description}
          </p>
        <div className="w-full h-[41.1px] bg-primary 
        md:h-[34.94px] lg:h-[64px]">
          <ul className='flex items-center justify-center 
          h-full gap-[19.22px] md:gap-[17px] lg:gap-[29.94px]'>
            <li>
