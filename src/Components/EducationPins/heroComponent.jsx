...
export default function HeroComponent() {
  return (
    <div className="educationPinsHero items-center w-[100%] rectangle1 flex justify-between 
     gap-[8.34px] min-h-[120.53px] pt-[5px] pr-[4.619px] pb-[8.824px] pl-[16.72px] lg:mb-[40px] mb-[20px] rounded-[6.667px] 
   ...
   md:rounded-[11.736px] lg:py-[20px] lg:pl-[60px] lg:pr-[15px] lg:gap-[20px] lg:h-[200px]
      lg:rounded-[20px]"> 
        <div className="flex flex-col gap-[5.016px]  w-[80%] lg:gap-[15px] md:gap-[8.802px]">
            ...
            <h2
              className="
                font-[600] leading-[16px] text-[12px] text-black 
     md:text-[14.75px] md:leading-[22px]
      ...
      "
            ...
            {/* sub-text */}
            <p
              className="font-[400] text-[9px] leading-[12.1px]  
      ...
      lg:text-[16px] lg:leading-[20.8px] text-black"
         ...
         Purchase an affordable education scratch pins / token to{' '}
          ...
          <div className="w-[25%] h-[100%] flex items-center">
            <img
              src={remoteEducation}
              className="w-[100%] md:h-[100%] h-[65px] "
              alt=""
            />
          </div>
        </div>
