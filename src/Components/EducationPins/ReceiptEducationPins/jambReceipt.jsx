          ...
          <div className="flex flex-col gap-7  md:gap-10">
            ...
            mx-auto lg:gap-[8px]">
              ...
              justify-between  lg:text-[16px] font-[500]">
                ...
                <span>JAMB E-PINS</span>
              </div>
              <div className="flex text-[10px] md:text-[14px] w-[90%] mx-auto 
              justify-between  lg:text-[16px] font-[500]">
                <p className="text-[#7C7C7C]">JAMB PIN Generated</p>
...
{/* ===============FOOTER=========== */}
      ...
      >
        <div className="flex gap-2 justify-center items-center mb-[50px] 
        md:mt-40 mt-[100px] lg:mt-[100px]">
          ...
          <Link
            ...
            className="text-[8px] leading-[12px] text-white
             bg-primary px-2 py-1 rounded-full lg:text-[16px] lg:px-[10px] lg:py-[10px]"
          >
            Contact Us
          </Link>
        </div>
