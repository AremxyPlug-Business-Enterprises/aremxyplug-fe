  ...
  const handleShareClick = async() => {
     ...
     //  alert(pdf.internal?.pageSize.getHeight())
      ...
      if (navigator.canShare && navigator.canShare({files : [file]})) {
        navigator
          .share({
            title: "AremxyPlug_NABTEB_Receipt",
            files : [file], 
          })
          .then(() => {return;})
          .catch((error) => {return;});
        ...
        >
          ...
          <div ref={contentRef}>
            ...
            >
              ...
              <p
                className="text-[10px] p-[5.729px] border-[0.573px] rounded-[6.302px] md:p-[5.868px] md:border-[0.578px] md:rounded-[6.455px]  lg:border lg:rounded-[11px] border-[#27AE60] leading-[15px] md:leading-[20px] text-[#27AE60] bg-[#D5F6E3] lg:p-2.5 text-center my-2 md:text-sm lg:text-base  lg:leading-6 font-medium md:mb-7"
              >
