...
const AirtimeVtu = () => {
    ...
    const handleProceed = (e) => {
        ...
        } else if (!mtnRegex.test(recipientNumber)) {
            setErrors({
              recipientNumber:
