  ...
  const CopyButton = ({ textToCopy }) => {
    ...
    return (
      <button onClick={handleCopyClick}>
        <img
          src="./Images/currencyImages/copy.svg"
          alt=""
          className="md:w-[13px] md:h-[15px] lg:w-[21px] lg:h-[27px]"
        />
      </button>
    );
  };
      ...
      <DashBoardLayout>
        ...
        <div className="">
          ...
          >
            <div className="py-[9.57px] md:py-[16.61px] lg:py-[29px] align-middle self-center flex flex-col gap-1.5 w-[70%]">
              <p className="text-[9px] lg:text-[24px] md:text-[13.75px] font-semibold ">
                CONVERT FIAT CURRENCY WITH AREMXYPLUG.
              </p>
              <p className="text-[7.5px] lg:text-[20px] md:text-[11.46px]">
                Convert from one fiat currency to another without any hassle,
                enjoy competitive exchange rate with no any hidden fee.
              </p>
            </div>
          ...
          <div className=" mx-auto flex gap-1.5 py-[25.29px] lg:py-[50px] md:py-[28.64px]">
            <div className="text-[8px] lg:text-xl md:text-[11.46px] font-medium text-[#7C7C7C]">
              Select the below fiat currency to convert
            </div>
            <div>
              <img
          ...
          <div
            ...
            onClick={() => setConversionRate(true)}
          >
          ...
          <div className="mx-auto ">
            <div className="flex gap-1 lg:gap-2 lg:my-[40px] md:my-[30px] my-[20px]">
              <p className="text-[8px] md:text-[11.46px] lg:text-xl font-medium">
                From
              </p>
              <img
                src="./Images/currencyImages/right.svg"
            ...
            <div className="available flex justify-between w-[160px] md:w-[210px] lg:w-[360px] h-[16px] lg:h-[41px] md:h-[20px] border-[#000000] border-opacity-30 rounded-[4px] md:rounded-[6px] lg:rounded-[8px] border-[0.8px] mx-auto my-7 px-2">
              <input
                ...
                className="text-[7px] text-[#7C7C7C] md:text-[12px] lg:text-[16px] font-medium "
              />
              <div className="flex self-center">
                <img
                  src="./Images/currencyImages/nigeria.svg"
                  alt=""
                  className="lg:h-[24px] lg:w-[24px] md:h-[16px] md:w-[16px] flex"
                />
              </div>
            </div>
            ...
            <div className="flex justify-between gap-3 my-6 px-2">
              <div className="flex gap-[2px]">
                <img
                  src="./Images/currencyImages/rate.svg"
                  alt=""
                  className="lg:h-[24px] lg:w-[24px] md:h-[13.75px] md:w-[13.75px]"
                />
                {exchangeRate !== null ? (
                  <p className="text-[6px] whitespace-nowrap lg:text-[16px] md:text-[10px] font-semibold text-[#7C7C7C]">
                    {exchangeRate} NGN ~ 1 USD
                  </p>
                ) : (
                  <p>Loading exchange rate...</p>
                )}
              ...
              <div className="flex gap-[2px]">
                <img
                  src="./Images/currencyImages/fee.svg"
                  alt=""
                  className="lg:h-[24px] lg:w-[24px] md:h-[13.75px] md:w-[13.75px]"
                />
                <span className="text-[6px] whitespace-nowrap lg:text-[16px] md:text-[10px] font-semibold text-[#7C7C7C]">
                  {" "}
              ...
              <div className="flex gap-[2px]">
                <img
                  src="./Images/currencyImages/clock.svg"
                  alt=""
                  className="lg:h-[24px] lg:w-[24px] md:h-[13.75px] md:w-[13.75px]"
                />
                <span className="text-[6px] whitespace-nowrap lg:text-[16px] md:text-[10px] font-semibold text-[#7C7C7C]">
                  {" "}
                  Completion Time - instantly
                </span>
              </div>
            </div>
          ...
          <footer className="flex justify-center text-center pb-[10%] gap-[20px] mt-[200px]  md:mt-[750px]  lg:mt-[850px]">
            <div className="font-medium text-[10px] md:text-[10px] lg:text-[15px] self-center">
              You need help ?
            </div>
            <Link to="/ContactUs">
        ...
        {pinInput && (
          <Modal>
            ...
            >
              ...
              <hr className="h-[6px] bg-[#04177f] border-none md:h-[10px]" />
              <div
                className="font-extrabold text-[8px] md:text-[10px] lg:text-[16px] text-center my-[8%]
            "
              >
            ...
            >
              ...
              <div className="">
                ...
                <img
                  ...
                  alt="/"
                />
                <div className="text-[#7C7C7C] text-[8px] text-center mb-2 md:pb-2 lg:pb-3 md:text-[14px] lg:text-[12px]">
                  You have successfully converted &nbsp;
                  <span className="text-black font-extrabold text-[10px] md:text-[16px] lg:text-[14px]">
                    {initialValue}.00
                  </span>
                  &nbsp; from your NGN wallet to
                </div>
              ...
              <div className="bg-[#F2FAFF] mx-10 h-[45px] my-5 flex justify-between items-center px-[4%] md:h-[65px] lg:h-[75px]">
                <div className="text-[6px] text-center mx-auto w-[171px] md:text-[14px] md:w-[80%] lg:text-[14px]">
                  The conversion has been sent successfully. Please check the
                  correspondent wallet to view the value.
                </div>
              </div>
              ...
              <div className="flex w-full justify-center items-center gap-[10px] md:gap-[8.59px] lg:gap-[15px] md:pb-2">
                ...
                <Link to="/SuccessfulConversion">
                  <button
                    ...
                    className={`border-[1px]  w-[111px] lg:w-[200px] md:w-[99px] h-[40px] md:h-[24px] lg:h-[42px] lg:my-[2%] flex justify-center items-center cursor-pointer text-[12px] md:text-[12px] lg:text-[16px] font-semibold rounded-[6px] md:rounded-[7px] lg:rounded-[12px]`}
                  >
                    Receipt
                  </button>
                </Link>
