      ...
      <div className="flex flex-col gap-[35px] lg:gap-[85px]">
        ...
        >
          ...
          <div ref={contentRef}>
            ...
            <div className="text-[8px] md:text-[10px] lg:text-[16px] text-[#F95252]">Transaction Failed due to an unexpected error that occured. Please try again.</div>
