...
const CurrencyConversion = () =>{
  ...
  const closeModal1 = () => {
    ...
    return(
        ...
        <DashBoardLayout>
        {/* <Nav/> */}
        <div className="w-[360px] lg:w-[1160px] md:w-[825px]">
        
          <div id='background' className="h-[64.71px] lg:h-[196px] md:h-[112.29px] rounded-[6.6px] md:rounded-[11.46px] lg:rounded-[20px] mx-auto w-[312px] md:w-[536.25px] lg:w-[1100px] flex gap-5 px-[16.51px] md:px-[28.65px] lg:px-[50px]">
          ...
          <div className="w-[312px] md:w-[536.25px] lg:w-[1100px] mx-auto flex gap-3 py-[5px] lg:py-[50px] md:py-[28.64px]">
                   <div className="text-[8px] lg:text-lg md:text-[11.46px] font-medium text-[#7C7C7C]">
                <div className="w-[312px] md:w-[536.25px] lg:w-[1100px] mx-auto flex gap-3 py-[25.29px] lg:py-[20px] md:py-[15px]">
     ...
     {/* select conversion */}
         <div id="lists" className="flex flex-col gap-[8.6px] lg:gap-[25px] md:gap-[14.32px]">
            ...
            {/* fiat conversion */}
              <Link to= './fiat'>
              <div className="conversionLists cursor-pointer hover:bg-[#7C7C7C] hover:bg-opacity-10 flex pl-[5px] pr-[25px] md:pr-[36px] lg:pr-[60px] md:pl-[8.59px] lg:pl-[15px] justify-between w-[312px] md:w-[536.25px] lg:w-[1100px] mx-auto py-[7px] md:py-[9px] lg:py-[15px] rounded-[4px] md:rounded-[6.88px] lg:rounded-[12px]">
          ...
          {/* crypto conversion */}
          <div onClick={openModal1} className="conversionLists hover:bg-[#7C7C7C] hover:bg-opacity-10 cursor-pointer flex pl-[5px] pr-[25px] md:pr-[36px] lg:pr-[60px] md:pl-[8.59px] lg:pl-[15px] justify-between w-[312px] md:w-[536.25px] lg:w-[1100px] mx-auto py-[7px] md:py-[9px] lg:py-[15px] rounded-[4px] md:rounded-[6.88px] lg:rounded-[12px]">
            <div className="flex gap-2">
                <img src={fiat} alt="fiat.svg" className="flex self-center lg:h-[24px] lg:w-[24px] md:h-[13.75px] md:w-[13.75px]" />
                <div className="flex flex-col">
          ...
          <Modal isOpen={isModalOpen1} onClose={closeModal1}>
            ...
            <button className="bg-[#04177F] flex mx-auto rounded-[4.6px] md:rounded-[7px] lg:rounded-[12px] w-[255px] md:w-[58px] lg:w-[93px] h-[30px] lg:h-[34px] md:h-[23px]">
          ...
          <div onClick={openModal}  className="conversionLists cursor-pointer hover:bg-[#7C7C7C] hover:bg-opacity-10 flex pl-[5px] pr-[25px] md:pr-[36px] lg:pr-[60px] md:pl-[8.59px] lg:pl-[15px] justify-between w-[312px] md:w-[536.25px] lg:w-[1100px] mx-auto py-[7px] md:py-[9px] lg:py-[15px] rounded-[4px] md:rounded-[6.88px] lg:rounded-[12px]">
            <div className="flex gap-2">
