...
export default function Referral() {
  return (
    ...
    <div className='rectangle1 flex justify-between  gap-[18.34px]  min-h-[65.33px] w-[100%]  
  ...
  lg:py-[8px] lg:pl-[60px] lg:pr-[50px] lg:gap-[55px] lg:h-[196px]'>
        {/* Container CONTENT_ONE LEFT_SIDE  */}
       <div className='flex flex-col gap-[5px] w-[65%] lg:gap-[15px] md:gap-[8.594px]'>
        {/* header */}
     <h2 className='font-[600] leading-[12px] text-[8px] text-[#000] mt-[15px] 
     md:text-[13.75px] md:leading-[21px]
      lg:text-[24px] lg:leading-[36px]'>
      REFER AND EARN, ALL IN ONE WITH<br/>
      AREMXYPLUG.
      </h2>
      {/* sub-text */}
      <p className='font-[400] text-[7px] leading-[9.1px] 
      md:text-[9.167px]  md:leading-[11.917px]
      lg:text-[16px] lg:leading-[20.8px] '>
     <span className='md:block'> Refer your friends and family with your referral link /
     code and earn free </span>
    <span className='md:block'>points,redeem to real money, 
      withdrawn to your bank account instantly.</span>
    </p>
       </div>
       <div className='w-[35%]'>
        <img src={Refer1} className='w-[100%] md:h-[100%] h-[60px]' alt="" />
       </div>
</div>
{/* INPUT_CONTENT */}
<div className='flex flex-col gap-[20px] mb-[30px]'>
  {/* INPUT_ONE */}
 <div className='flex flex-col gap-[2.667px]'>
  <h2 className='font-[600] text-[8px] leading-[12px] 
  md:text-[9.167px] md:leading-[14px]
  lg:text-[16px] lg:leading-[24px]'>
  Your Referral Link is:
  </h2>
   <div className='flex pl-[5px]  gap-[16.33px]  
   border-[0.333px] rounded-[7.333px] h-[18px] items-center
    ...
    {/* THE REFER LINK */}
       ...
       <p className='w-[75%] font-[600]  text-[#7C7C7C] text-[7px] leading-[11px]
       lg:text-[16px] lg:leading-[24px]
        md:text-[9.167px] md:leading-[14px] md:pl-[10px]'>
       ...
       <img src={copyRefer} className='lg:h-[24px] lg:w-[24px] cursor-pointer' alt="copy" />
       <p className='  font-[500] text-[7px] leading-[11px] text-white 
...
lg:text-[16px] lg:leading-[24px]'>
 ...
 <div className='flex flex-col md:flex md:flex-row md:justify-between'>
  {/* CHECK POINT BALANCE BUTTON */}
   ...
   <a href="#" className='md:self-center text-center font-[600] leading-[10.4px] text-[8px] 
    shadow-[2.29167px]
   ...
   <p className='text-[8px] text-center text-[#7C7C7C] py-[5.729px] font-[600] leading-[12px] 
   border-b-[1px] border-b-[#CED9FF]
   ...
   <a href="#" className='cursor-pointer'>
    <img src={facebook} className='lg:h-[60px] lg:w-[60px]' alt="facebook-icon" />
    </a>
    {/* twitter */}
  <a href="#" className='cursor-pointer'>
     <img src={twitter} className='lg:h-[60px] lg:w-[60px]' alt="twitter-icon" />
     </a>
     {/* instagram */}
   <a href="#" className='cursor-pointer'>
    <img src={instagram} className='lg:h-[60px] lg:w-[60px]' alt="instagram-icon" /> 
    </a>
    {/* whatsapp */}
  <a href="#" className='cursor-pointer'>
    <img src={whatSapp} className='lg:h-[60px] lg:w-[60px]' alt="Whatsapp-icon" />
    </a>
    </div>
     </div>
     </div>
...
<p className='font-[600] text-[8px] text-[#7C7C7C] leading-[12px]
md:text-[11.458px] md:leading-[17px]
lg:text-[20px] lg:leading-[30px]'>
  Referral Analysis
  </p>
  {/* arrow */}
<img src = {rightArrow} className='self-center md:w-[13.75px] md:h-[13.75px] lg:w-[24px] lg:h-[24px]' 
 alt="rightArrow" />
</div>

{/* Referral boxes */}
<div className='flex gap-[21px] md:gap-[51.849px] lg:gap-[90.5px] mb-[20px]'>
  {/* box-1 */}
  <div className='flex flex-col w-1/3 md:w-auto rounded-[1.97px] justify-center
   bg-[#D5F6E3] md:py-[8.597px] md:px-[22.917px] 
   gap-[1.641px] py-[4.924px] px-[5px] lg:px-[40px] lg:py-[15px] lg:rounded-[6px]'>
    {/* TOTAL REFERRAL */}
    <div className='flex justify-center gap-[5px]'>
  <h2 className='font-style text-[#000000] font-[500] text-center text-[10px] leading-[15px]
  lg:text-[16px] lg:leading-[24px]'>
    Total Referrals 
    </h2>
    <img src= {arrowDown} className='lg:w-[16px] lg:h-[16px]
     w-[4.924px] h-[4.924px] self-center' alt="arrowDown" /> 
    </div>
  <h2 className='font-style font-[500] text-[10px] text-center leading-[15px]
  lg:text-[16px] lg:leading-[24px]'>
    100
  </h2>
  </div>
  {/* box-2 */}
  <div className='flex w-1/3 md:w-auto justify-center flex-col rounded-[1.97px] bg-[#92ABFE2E]
 ...
 {/* ACTIVE REFFERAL */}
  ...
  lg:text-[16px] lg:leading-[24px]'>
    ...
    <img src= {arrowDown} className='lg:w-[16px] lg:h-[16px]
     w-[4.924px] h-[4.924px] self-center' alt="" /> 
    </div>
  <h2 className='font-style font-[500] text-[10px] text-center leading-[15px]
  lg:text-[16px] lg:leading-[24px]'>
    70
  ...
  {/* box-3 */}
  <div className='flex w-1/3 md:w-auto flex-col rounded-[1.97px] bg-[#FDCECE]
...
<div className='md:hidden flex flex-col p-[20px] border-x-[1.2px]
 border-[#7C7C7C] border-opacity-[25%]'>
  {/* analysis 1 */}
  <div className='flex justify-between pb-[31.5px] border-b-[1px] border-b-[black]
   border-opacity-[20%]'>
    {/* left */}
  ...
  Aremxyplug
   ...
   <p className='font-[600] text-[#7C7C7C] text-[9.167px] leading-[11.167px]'>
    aremxyplug
     ...
     <p className='font-[600] self-end text-[9.167px] leading-[11.167px] cursor-pointer
...
{/* analysis2 */}
<div className='flex justify-between py-[31.5px] border-b-[1px] border-b-[black]
   border-opacity-[20%]'>
    {/* left */}
      <div className='flex flex-col gap-[7.648px]'>
   <h2 className='font-[600] text-[9.167px] leading-[11.167px]'>
...
<div className='flex gap-[5.729px] py-[2.865px] justify-center px-[8.594px]'>
 <p className='font-[500] text-[8px] text-[#707070] leading-[10.4px]'>
  ...
  <a href="#" className='font-[500] text-white text-[8px]  py-[2.865px] 
...
{/* TABLE FOR LARGE SCREENS */}
   ...
   justify-start'>
     <table className='h-[700px] md:h-[401.04px]  lg:gap-[64px] 
     md:shadow-lg border-collapse font-[inter]'>
        {/* ROW ONE */}
   <tr className='flex w-[100%] md:pt-[6.312px]  md:pr-[15.473px] md:pb-[5.746px] md:pl-[16.308px]
   lg:pr-[27px]  lg:pl-[28px] lg:pt-[11px]  lg:pb-[10px]
    bg-[#CED9FF] '>
        <th className='text-left lg:text-[16px] lg:leading-[20.8px]  w-1/5 border-none md:text-[9.167px] md:leading-[11.917px]'>
          Date/Time
          </th>
        <th className='text-left w-1/5 md:text-[9.167px] md:leading-[11.917px] border-none
        lg:text-[16px] lg:leading-[20.8px]'>
          Name
          </th>
        <th className='text-left w-1/5 md:text-[9.167px] md:leading-[11.917px] border-none
        ...
        <th className='text-left w-1/5 border-none md:text-[9.167px] md:leading-[11.917px]
        lg:text-[16px] lg:leading-[20.8px]'>
          Status
          </th>
  </tr>
  <tr className='flex w-[100%] '>
    <td className='w-1/5 lg:pt-[30.5px] lg:pb-[28.5px]  pt-[30.5px] pb-[28.5px]  
    md:pt-[17.51px] md:pb-[16.36px]'>
      <p className='lg:text-[16px] text-left font-[600] leading-[20.8px] border-none
    ...
    <p className='lg:text-[16px] text-left font-[600] lg:leading-[20.8px] 
    md:text-[9.167px] md:leading-[11.917px] '>
     <span className='md:block'>Habib</span>
     <span className='md:block'>Kamaldeen</span>
      </p>
    </td>
    <td className='w-1/5 pt-[30.5px]  pb-[28.5px] lg:pt-[30.5px] lg:pb-[28.5px] 
    md:pt-[17.51px] md:pb-[16.36px]'>
    <p className='lg:text-[16px] text-left font-[600] lg:leading-[20.8px]
    md:text-[9.167px] md:leading-[11.917px]'>
      Aremxyplug
    ...
    <td className='w-1/5 flex-start pt-[30.5px] pb-[28.5px]  md:pt-[17.51px] md:pb-[16.36px]
    ...
    md:text-[9.167px] md:leading-[11.917px]'>
     ...
     <td className='w-1/5 flex justify-start items-start pt-[30.5px]
  ...
  <tr className='flex w-[100%] '>
    ...
    <td className='w-1/5 pt-[30.5px] pb-[28.5px]  md:pt-[17.51px] md:pb-[16.36]
    lg:pt-[30.5px] lg:pb-[28.5px]'>
    <p className='lg:text-[16px] text-left font-[600] lg:leading-[20.8px]
    md:text-[9.167px] md:leading-[11.917px]'>
     <span className='md:block'>Habib</span>
    ...
    md:text-[9.167px] md:leading-[11.917px]'>
     ...
     <td className='w-1/5 flex justify-start items-start pt-[30.5px] pb-[28.5px]
  ...
  <tr className='flex w-[100%] '>
    ...
    <td className='w-1/5 flex-start  md:pt-[17.51px] md:pb-[16.36px]
    lg:pt-[30.5px] lg:pb-[28.5px]'>
    <p className='lg:text-[16px] text-left font-[600] leading-[20.8px] 
    md:text-[9.167px] md:leading-[11.917px]'>
      aremxyplug
      </p>
    </td>
     <td className='w-1/5 flex justify-start items-start md:pt-[17.51px] md:pb-[16.36px]
      lg:pt-[30.5px] lg:pb-[28.5px]'>
       <p className='lg:text-[16px] text-left font-[600] lg:leading-[20.8px]
        py-[4px] px-[12px] bg-[#CED9FF] md:text-[9.167px] md:leading-[11.917px] md:rounded-[3.438px]'>
        Active
  ...
  <tr className='flex w-[100%] '>
    <td className='w-1/5  md:pb-[16.36px] md:pt-[17.51px]
    lg:pt-[30.5px] lg:pb-[28.5px]'>
      <p className='lg:text-[16px] text-left font-[600] lg:leading-[20.8px]
    ...
    <td className='w-1/5 flex-start md:pb-[16.36px] md:pt-[17.51px]
    lg:pt-[30.5px] lg:pb-[28.5px]'>
    <p className='lg:text-[16px] text-left font-[600] lg:leading-[20.8px] 
    md:text-[9.167px] md:leading-[11.917px] '>
      aremxyplug
     ...
     <td className='w-1/5 flex justify-start items-start md:pb-[16.36px]
     lg:pt-[30.5px] lg:pb-[28.5px]'>
       <p className='lg:text-[16px] text-left font-[600] lg:leading-[20.8px]
        py-[4px] px-[12px] bg-[#FDCECE] md:text-[9.167px] md:leading-[11.917px] md:rounded-[3.438px]'>
        Inactive
...
<div className='flex md:gap-[14.896px] py-[10.865px] justify-center px-[8.594px]'>
 <p className='font-[500]  lg:text-[12px] lg:leading-[15.6px]  md:text-[6.875px]
  text-[#707070] md:leading-[8.938px]'>
  You need help?
  </p>
  <a href="#" className='font-[500] text-white lg:text-[8px] lg:leading-[10.4px] 
  md:text-[4.583px]  py-[2.865px] 
 px-[8.594px] md:leading-[5.985px] rounded-[5.156px] bg-[#04177F]'>
  Contact Us</a>
  </div>
     </table>
   </div>
