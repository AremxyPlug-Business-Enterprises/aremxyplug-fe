...
export const EligibilityRules = () => {
  const rules = [
    "All users can now participate during the extended testing phase.",
    "Only users who complete 100% of required tasks are eligible for Testing Phase rewards.",
    "Earning the Beta Badge is required for qualification.",
    "All activities — transactions, referrals, and submissions — will be verified before rewards are distributed.",
  ];
    ...
    <section className="w-full px-6 py-20 bg-[#EAF3FF]">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          {/* 🔥 NEW subtle update badge */}
          <p className="mt-3 text-sm text-[#356DFF] font-medium">
            Updated for extended testing phase
          </p>

          <p className="text-[#4A4A4A] mt-2 text-lg">
            Please review to understand how qualification works.
          </p>
        </motion.div>
...
//OLD CODE FOR ELIIGIBILITY SECTION
// import { motion } from "framer-motion";
