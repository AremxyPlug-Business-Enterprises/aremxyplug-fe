...
export default function TestingHeroSection() {
  return (
    <section className="w-full relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 py-32 flex flex-col lg:flex-row gap-16 items-center justify-between">
        ...
        >
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            ...
            From 24 November to 07 December, we’re opening controlled access to our platform to allow waitlisted users to test, explore, and help improve the product before public launch.
          </p>
        </motion.div>
