      ...
      <div class="flex gap-[25px] lg:w-full lg:h-[1850px] md:h-[1200px] h-[800px] md:w-full w-full flex-col">
        ...
        <div className="flex gap-[8px] md:gap-[10px] lg:mt-[25px] mt-[6px] md:mt-[10] flex-row">
          ...
          <div class="w-4 h-4 lg:h-6 lg:mt-1 lg:w-6 md:w-[15.75px] md:h-[15.75px] justify-center items-center inline-flex">
            <img
              src={arrowsales}
              class="w-4 h-4 lg:h-6 lg:w-6 md:mt-[8px] mt-1  md:w-[15.75px] md:h-[15.75px] relative"
              alt=""
            />
          </div>
...
gap-[5px] mt-[-0%] lg:mt-[25px] bg-indigo-300
 bg-opacity-20 md:rounded-[11.46px] lg:rounded-[20px] rounded-[6px]
  ...
  md:px-[140.10px] md:py-[14.32px] relative items-center inline-flex"
   ...
   px-[2px] rounded-[3px] md:px-[8px] mt-[-1px] md:mt-[1px] flex-row`}
            >
              <div
                class="text-[#04177f] text-[9px] lg:text-[20px] flex items-center md:text-[16px] 
        whitespace-nowrap font-bold relative"
              >
                Filter by Date
              </div>
              <div class="w-4 h-4 lg:h-6 lg:mt-1 lg:w-6 md:w-[15.75px] md:h-[15.75px] justify-center items-center inline-flex">
                <img
                  ...
                  className=" md:mt-[1px] lg:mt-[-2px]
             mt-[-2px] w-[12px] h-[12px] md:w-[17px] md:h-[17px] lg:w-[20px] lg:h-[20px] relative"
                  alt=""
                />
              </div>
            </div>
              ...
              <div class="justify-start items-center lg:gap-[5px] gap-[2.86px] flex">
                <div class="w-[11.37px] h-[11.37px] lg:w-[19.85px] lg:h-[19.85px] justify-center items-center flex">
                  <div class="w-[11.37px] h-[11.37px]  md:w-[20px] md:h-[19px] lg:w-[19.85px] lg:h-[19.85px] relative">
                    <img
                      className="w-[11.37px] h-[11.37px] md:w-[20px] md:h-[19px] lg:w-[19.85px] lg:h-[19.85px]"
                      src={menusales}
                      alt=""
                    />
                  </div>
                ...
                <div
                  className="text-neutral-500 whitespace-nowrap lg:whitespace-nowrap lg:text-[20px]
                 md:mt-[-1px] text-[10px] md:text-[16px] md:whitespace-nowrap font-semibold "
                >
                  {selectedProduct}
                </div>
              </div>
          ...
          {calender && (
            <div className="mt-[260px] md:mt-[336px] absolute  z-50 lg:mt-[575px]">
              <Calender />
            </div>
          )}
          ...
          <div
            class="flex md:w-full w-full border-opacity-100 lg:mt-[-80px] mt-[-22px]
     md:mt-[-45px] lg:w-full shadow border-black flex-col"
          >
            <div
              class="w-full h-[25px] lg:pr-0 pl-[8.67px] pr-[1.33px] pt-[8.17px] pb-[6.83px]
     ...
     lg:h-[42px] md:h-[24.06px]  md:pl-[14.90px] md:pr-[2.29px]
      md:pt-[6.32px] md:pb-[5.74px] bg-indigo-200 justify-evenly
       lg:justify-between md:justify-evenly items-center inline-flex"
            >
              <div
                class="self-stretch md:justify-between md:w-full lg:justify-between 
        lg:gap-[300px]  lg:w-full justify-start items-start gap-[66px] md:gap-[113.44px] inline-flex"
              >
                <div class="w-[56.33px] md:w-[96.82px] lg:w-full text-black text-[8px] md:text-[12px] lg:text-[16px] font-semibold  md:leading-3 lg:leading-tight  leading-[10.40px]">
                  Products
                </div>
                <div class="w-[53.33px] md:w-[91.67px] lg:w-full text-black text-[8px] md:text-[12px] lg:text-[16px] font-semibold  md:leading-3 lg:leading-tight  leading-[10.40px]">
                  Quantity
                </div>
                <div class="w-[60.33px] md:w-[103.70px] lg:w-full text-black text-[8px] md:text-[12px] lg:text-[16px] font-semibold md:leading-3 lg:leading-tight leading-[10.40px]">
                  Total Amount
                </div>
              </div>
            </div>
              ...
              <div class="w-44 h-[29px] md:w-[200px] md:h-[35px] lg:h-[40px]  bg-white shadow">
                <div class="w-[199.37px] ml-[5px] md:w-[199.37px] justify-start items-center inline-flex">
                  <div
                    ...
                    class="w-[186.20px] text-neutral-500 md:w-[131px] items-center text-[9px] md:text-[12px] lg:text-[16px] font-medium  md:leading-3 leading-[10.48px]"
                  >
                    Airtime Top-up
                  </div>
                </div>
              ...
              <div class="w-44 h-[29px] md:w-[200px] md:h-[35pxpx] lg:h-[40px] bg-white shadow">
                <div class="w-[199.37px] ml-[5px] md:w-[199.37px]  justify-start items-center inline-flex">
                  <div
                    ...
                    class="w-[186.20px] text-neutral-500 text-[9px] md:text-[12px] md:w-[131px] items-center lg:text-[16px] font-medium  md:leading-3 leading-[10.48px]"
                  >
                    Data Top-up
                  </div>
                </div>
              ...
              <div class="w-44 h-[29px] md:w-[200px] lg:h-[40px] md:h-[35px] bg-white shadow">
                <div class="w-[199.37px] ml-[5px] md:w-[199.37px]  justify-start items-center inline-flex">
                  <div
                    ...
                    class="w-[131.60px] text-neutral-500 text-[9px] md:text-[12px] md:w-[131px] items-center lg:text-[16px] font-medium  md:leading-3 leading-[10.48px]"
                  >
                    Bills Payments
                  </div>
                </div>
 ...
 flex justify-center text-center gap-[20px] 
          ...
          {isOpen5 && (
           ...
           top-[280px] md:top-[406px] absolute flex-col lg:items-start inline-flex`}
            ...
            md:h-[16.77px] md:ml-[11px] md:mt-[12px]"
                  ...
                  handleBalance(
                    <div
                      className="text-neutral-500 text-[9px] lg:mt-[5px] md:text-[13px] lg:text-xl lg:font-medium 
            ...
            justify-start items-center pt-[3px] pb-[px] bg-white shadow gap-[5px] pl-2 md:pl-2 md:gap-[5px] 
              ...
              <div
                onClick={() => {
                  ...
                  handleSelect(
                    <img
                      className="lg:w-[28.77px] w-3 lg:h-[26.09px]
            h-3 lg:left-[0.50px] lg:top-[3.18px] md:w-[16.77px]
            md:h-[16.77px] md:ml-[11px] ml-[19px] mt-[7px] lg:mt-[2px] lg:ml-[2px] md:mt-[12px]"
                      src={flagpage1}
                      alt=""
                    />
                  );
          ...
          font-medium  md:leading-3 leading-tight"
              ...
              <div
                onClick={() => {
                  ...
                  handleSelect(
                   ...
                   lg:mt-[2px] lg:ml-[2px] md:ml-[11px] md:mt-[12px] "
                      src={flagpage3}
                      alt=""
                    />
                  );
             ...
             justify-start items-center lg:pt-[7px] lg:pb-[7.73px] bg-white shadow 
              ...
              <div
                onClick={() => {
                  ...
                  handleSelect(
                    <img
                      className="lg:w-[29.27px] ml-[19px] mt-[7px] lg:h-[29.27px] lg:left-[0.50px] 
                  lg:top-[0.51px] h-3 w-3 md:w-[16.77px] md:h-[16.77px]
                  md:ml-[11px] md:mt-[12px] lg:mt-[2px] lg:ml-[2px]"
                      src={flagpage4}
                      alt=""
                    />
                  );
            ...
            md:leading-3 leading-tight"
             ...
             lg:h-[45px] h-[30px] justify-start items-center lg:gap-[5px] lg:w-[370px] bg-white shadow
              ...
              <div
                onClick={() => {
                  ...
                  handleSelect(
                    <img
                      className="lg:w-[29.27px] ml-[19px] mt-[7px] md:w-[16.77px] 
              md:h-[16.77px] w-3 h-3 lg:mt-[2px] lg:ml-[2px]
                   lg:h-[29.27px]
                   md:ml-[11px] md:mt-[12px]  "
                      src={flagpage5}
                      alt=""
                    />
                  );
             ...
             justify-start items-center lg:pb-[7.73px] bg-white shadow lg:gap-[5px] md:h-[35px]
              ...
              >
                <img
                  className="lg:w-[29.27px]  md:w-[16.77px] md:h-[16.77px] w-3 h-3 
  ...
  items-center inline-flex`}
                  >
                    <div class="lg:w-[100px] lg:text-base md:w-[96.82px] md:whitespace-nowrap  md:text-[12px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[8px] font-medium leading-[10.40px]">
                      MTN VTU
                    </div>
                    <div class="lg:w-[100px] lg:text-base md:w-[91.67px]  md:text-[12px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium leading-[10.40px]">
                      100
                    </div>
                    <div class="lg:w-[100px] lg:text-base md:w-[91.67px]  md:text-[12px] md:leading-3 lg:leading-tight w-[60.33px] text-black text-[8px] font-medium leading-[10.40px]">
                      (₦10,000.00)
                    </div>
                  </div>
                  <div
   ...
   justify-between md:justify-between lg:justify-start  items-center inline-flex`}
                  >
                    <div class="lg:w-[100px] lg:text-base md:w-[96.82px]  md:text-[12px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[8px] font-medium leading-[10.40px]">
                      MTN SNS
                    </div>
                    <div class="lg:w-[100px] lg:text-base md:w-[91.67px]  md:text-[12px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium leading-[10.40px]">
                      100
    ...
    pt-3 pb-[11.67px] bg-white justify-between md:justify-between lg:justify-start md:whitespace-nowrap
     items-center inline-flex`}
                  >
                    ...
                    <div class="lg:w-[100px] lg:text-base lg:leading-tight md:w-[91.67px]  md:text-[12px] md:leading-3 w-[60.33px] text-black text-[8px] font-medium  leading-[10.40px]">
                      (₦10,000.00)
                    </div>
                  </div>
                  <div
   ...
   lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-2 pb-[7.66px] bg-white
    justify-between md:justify-between lg:justify-start  md:whitespace-nowrap items-center inline-flex`}
                  >
                    <div class="lg:w-[100px] lg:text-base md:w-[96.82px]  md:text-[12px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[7px] font-medium  leading-[9.10px]">
                      GLO VTU
                    </div>
                    <div class="lg:w-[100px] lg:text-base md:w-[91.67px]  md:text-[12px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium  leading-[10.40px]">
                      100
  ...
  lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-2 pb-[7.67px] bg-white
   ...
   lg:pl-[26px] lg:pr-1  w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-2 pb-[7.67px] bg-white
    justify-between md:justify-between lg:justify-start  md:whitespace-nowrap items-center inline-flex`}
                  >
                    <div class="lg:w-[100px] lg:text-base lg:leading-tight md:w-[96.82px]  md:text-[12px] md:leading-3 w-[56.33px] text-black text-[7px] font-medium leading-[9.10px]">
                      9MOBILE SNS
                    </div>
                    <div class="lg:w-[100px] lg:text-base md:w-[91.67px]  md:text-[12px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium leading-[10.40px]">
                      100
   ...
   md:justify-between lg:justify-start items-center inline-flex `}
                  >
                    <div class="lg:w-[100px] lg:text-base md:w-[96.82px]  md:text-[11px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[8px] font-medium leading-[10.40px]">
                  ...
                  <footer
                    className="flex justify-center lg:ml-[-20px] text-center gap-[20px] mt-[100px] mb-[50px]
       md:mt-[200px] lg:mb-[30px] lg:mt-[185px]"
          ...
          {isOpen3 && (
            <div className=" bg-white  h-[1150px] shadow lg:h-full  w-full ">
              ...
              <div
                className="flex  justify-start items-center lg:w-full shadow relative bg-white  md:mt-[-108px]
  ...
  items-center inline-flex`}
   ...
   lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-2 pb-[7.66px] bg-white
    justify-between md:justify-between lg:justify-start  md:whitespace-nowrap items-center inline-flex`}
                >
                  <div class="lg:w-[100px] lg:text-base md:w-[96.82px]  md:text-[12px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[7px] font-medium whitespace-nowrap leading-[9.10px]">
                    MTN DIRECT <br /> COUPON
                  </div>
                  <div class="lg:w-[100px] lg:text-base md:w-[91.67px]  md:text-[12px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium  leading-[10.40px]">
                    100GB
                  </div>
  ...
  lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-2 pb-[7.67px] bg-white
   ...
   lg:pl-[26px] lg:pr-1  w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-2 pb-[7.67px] bg-white
    justify-between md:justify-between lg:justify-start  md:whitespace-nowrap items-center inline-flex`}
                >
                  <div class="lg:w-[100px] lg:text-base lg:leading-tight md:w-[96.82px]  md:text-[12px] md:leading-3 w-[56.33px] text-black text-[7px] font-medium whitespace-nowrap leading-[9.10px]">
                    AIRTEL GIFTING
                  </div>
                  <div class="lg:w-[100px] lg:text-base md:w-[91.67px]  md:text-[12px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium leading-[10.40px]">
                    100GB
   ...
   md:justify-between lg:justify-start items-center inline-flex `}
                >
                  <div class="lg:w-[100px] lg:text-base md:w-[96.82px]  md:text-[11px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[8px] font-medium whitespace-nowrap leading-[10.40px]">
                    AIRTEL GIFTING
                  </div>
                  <div class="lg:w-[100px] lg:text-base md:w-[91.67px]  md:text-[12px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium leading-[10.40px]">
                    100GB
...
items-center inline-flex`}
                  >
                    ...
                    <div class="lg:w-[100px] lg:text-base md:w-[91.67px]  md:text-[11px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium leading-[10.40px]">
                      100
                    </div>
                    <div class="lg:w-[100px] lg:text-base md:w-[91.67px]  md:text-[11px] md:leading-3 lg:leading-tight w-[60.33px] text-black text-[8px] font-medium leading-[10.40px]">
                      (₦10,000.00)
                    </div>
                  </div>
                  <div
 ...
 lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px]
  pt-3 pb-[11.67px] bg-white justify-between md:justify-between lg:justify-start  items-center inline-flex`}
                  >
                    ...
                    <div class="lg:w-[100px] lg:text-base lg:leading-tight md:w-[91.67px]  md:text-[11px] md:leading-3 w-[60.33px] text-black text-[8px] font-medium  leading-[10.40px]">
                      (₦10,000.00)
                    </div>
                  </div>
                  <div
 ...
 lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-2 pb-[7.66px] bg-white
  justify-between md:justify-between lg:justify-start  items-center inline-flex`}
                  >
                    <div class="lg:w-[100px] lg:text-base md:w-[96.82px]  md:text-[11px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[7px] font-medium  leading-[9.10px]">
                      GOTV SUBSCRIPTION
                    </div>
                    <div class="lg:w-[100px] lg:text-base md:w-[91.67px]  md:text-[11px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium  leading-[10.40px]">
                      100
...
lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-2 pb-[7.67px] bg-white
 ...
 lg:pl-[26px] lg:pr-1  w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-2 pb-[7.67px] bg-white
  justify-between md:justify-between lg:justify-start  items-center inline-flex`}
                  >
                    <div class="lg:w-[100px] lg:text-base lg:leading-tight md:w-[96.82px]  md:text-[11px] md:leading-3 w-[56.33px] text-black text-[7px] font-medium leading-[9.10px]">
 ...
 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] lg:justify-start  pt-2 pb-[7.67px] bg-white
  justify-between md:justify-between items-center inline-flex`}
                  ...
                  <footer
                    className="flex justify-center lg:ml-[-20px] text-center gap-[20px] mt-[70px] mb-[50px]
