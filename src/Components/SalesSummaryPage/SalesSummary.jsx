...
export default function SalesSummaryPage ()  {
    ...
    const toggleDropdown1 = () => { setIsOpen1((prevIsOpen) => !prevIsOpen); };

    const toggleDropdown2 = () => { setIsOpen2((prevIsOpen) => !prevIsOpen);  }; 

    
    const [isOpen3, setIsOpen3] = useState(false); 

    const toggleDropdown3 = () => { setIsOpen3((prevIsOpen) => !prevIsOpen); };


    const [isOpen4, setIsOpen4] = useState(false);
    const toggleDropdown4 = () => { setIsOpen4((prevIsOpen) => !prevIsOpen); };
    ...
    <div class="flex gap-[10px] flex-row">
        ...
        <div class="w-3 h-3 md:w-[13.75px] md:h-[13.75px] justify-center items-center inline-flex">
            <img src={arrowsales} class="w-3 h-3 lg:w-6 lg:h-6 md:w-[13.75px] md:mt-[3px] md:h-[13.75px] lg:mt-[20px] relative"alt="" />
    ...
    <div class="w-[312px] h-6 pl-[0.33px] pr-[86.66px] py-[2.67px] lg:w-full lg:h-[72px] lg:pl-4 lg:pr-[459.30px] lg:gap-[50.53px] lg:py-[11px] md:w-full md:h-[41.25px] md:pl-[9.17px] md:pr-[262.40px] md:pt-[6.39px] md:pb-[6.40px] bg-white shadow border-t border-b border-black border-opacity-30 justify-start items-center gap-[52.80px] inline-flex">
        ...
        <div class="self-stretch relative justify-start items-center gap-[5.73px] lg:gap-2.5 inline-flex">
            <div class="justify-start items-center lg:gap-[5px] gap-[2.86px] flex">
                ...
                <div   className="text-neutral-500 md:text-xs text-[8px] lg:text-xl md:whitespace-nowrap font-semibold ">Filter By Product</div>
            </div>
            <div class="w-[11.37px] h-[11.37px] lg:w-[19.85px] lg:h-[19.85px] justify-center items-center flex">
  ...
  <div className="flex absolute lg:h-[300px] md:ml-[100px] left-[80px] md:left-[225px] lg:w-full md:h-[150px] h-[200px] md:top-[450px] lg:ml-[550px] lg:left-[10px] lg:top-[630px]  top-[285px] flex-col">
    <div class="w-44 h-[29px] md:w-[200px] md:h-[35px] lg:h-[40px]  bg-white shadow">
        ...
        <div class="w-[199.37px] ml-[5px] md:w-[199.37px] justify-start items-center inline-flex">
            <div onClick={toggleDropdown2} class="w-[186.20px] text-neutral-500 md:w-[131px] items-center text-[8.06px] md:text-[9.17px] lg:text-[15px] font-medium  md:leading-3 leading-[10.48px]">Airtime Top-up</div>
        </div>
    </div>
    ...
    <div class="w-44 h-[29px] md:w-[200px] md:h-[35pxpx] lg:h-[40px] bg-white shadow">
        ...
        <div class="w-[199.37px] ml-[5px] md:w-[199.37px]  justify-start items-center inline-flex">
            <div onClick={toggleDropdown3} class="w-[186.20px] text-neutral-500 text-[8.06px] md:text-[9.17px] md:w-[131px] items-center lg:text-[15px] font-medium  md:leading-3 leading-[10.48px]">Data Top-up</div>
        </div>
    </div>
    <hr class="bg-slate-500 h-[1px] w-[175px]"></hr>
    <div class="w-44 h-[29px] md:w-[200px] lg:h-[40px] md:h-[35px] bg-white shadow">
        ...
        <div class="w-[199.37px] ml-[5px] md:w-[199.37px]  justify-start items-center inline-flex">
            <div onClick={toggleDropdown4} class="w-[131.60px] text-neutral-500 text-[8.06px] md:text-[9.17px] md:w-[131px] items-center lg:text-[15px] font-medium  md:leading-3 leading-[10.48px]">Bills Payments</div>
        </div>
    </div>
    <hr class="bg-slate-500 h-[1px] w-[175px]"></hr>
  </div>
...
{isOpen2 && (
  <div className=" flex w-full md:w-full justify-between md:left-[100px] md:justify-between lg:justify-between lg:top-[900px] top-[450px] md:top-[630px] items-center lg:w-full gap-[30px] absolute flex-col">
    <div className='flex w-full md:w-full lg:w-full flex-col'>
<div class="lg:w-full lg:h-[101px] lg:pl-[26px] lg:pr-1  w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.67px] md:w-full md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] bg-white justify-around lg:ml-[-100px] items-center inline-flex">
    <div class="self-stretch justify-center items-center md:gap-[113.44px] lg:gap-[198px] gap-[66px] inline-flex">
...
<div class="w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.66px] md:w-full md:h-[57.86px] lg:w-full lg:h-[101px] lg:pl-[26px] lg:pr-1 md:pl-[14.90px] md:pr-[2.29px] bg-white justify-around lg:ml-[-100px] items-center inline-flex">
    <div class="self-stretch justify-center items-center md:gap-[113.44px] gap-[66px] lg:gap-[198px] inline-flex">
...
<div class="w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.67px] md:w-full md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] bg-white lg:w-full lg:h-[101px] lg:pl-[26px] lg:pr-1 justify-around lg:ml-[-100px] items-center inline-flex">
    <div class="self-stretch justify-center items-center gap-[66px] md:gap-[113.44px] lg:gap-[198px] inline-flex">
...
<div class="w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.67px] md:w-full md:h-[57.86px] md:pl-[14.90px] lg:w-full lg:h-[101px] lg:pl-[26px] lg:pr-1 md:pr-[2.29px] bg-white justify-around lg:ml-[-100px] items-center inline-flex">
    <div class="self-stretch justify-center items-center gap-[66px] md:gap-[113.44px] lg:gap-[198px] inline-flex">
...
<div class="w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.66px] md:w-full md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] bg-white justify-around items-center lg:w-full lg:h-[101px] lg:ml-[-100px] lg:pl-[26px] lg:pr-1 inline-flex">
    <div class="self-stretch justify-center items-center gap-[66px] md:gap-[113.44px] lg:gap-[198px] inline-flex">
...
<div class="w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.67px] md:w-full md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] bg-white lg:w-full lg:h-[101px] lg:pl-[26px] lg:pr-1 justify-evenly lg:ml-[-100px] items-center inline-flex">
    <div class="self-stretch justify-center items-center gap-[66px] md:gap-[113.44px] lg:gap-[198px] inline-flex">
...
<div class="w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.67px] md:w-full md:h-[57.86px] md:pl-[14.90px] lg:w-full lg:h-[101px] lg:pl-[26px] lg:pr-1 md:pr-[2.29px] bg-white justify-evenly lg:ml-[-100px] items-center inline-flex">
    <div class="self-stretch justify-center items-center gap-[66px] md:gap-[113.44px] lg:gap-[198px] inline-flex">
...
<div class="w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-[7px] pb-[6.66px] md:w-full md:h-[57.86px] md:pl-[14.90px] lg:w-full lg:h-[101px] lg:pl-[26px] lg:pr-1 md:pr-[2.29px] bg-white justify-evenly lg:ml-[-100px] items-center inline-flex">
    <div class="self-stretch justify-center items-center gap-[66px] md:gap-[113.44px] lg:gap-[198px] inline-flex">
...
<div class="w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-[7px] pb-[6.67px] md:w-full md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] bg-white lg:w-full lg:h-[101px] lg:pl-[26px] lg:pr-1 justify-evenly lg:ml-[-100px] items-center inline-flex">
    <div class="self-stretch justify-around items-center gap-[66px] md:gap-[113.44px] lg:gap-[198px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] mt-[200px] lg:pl-[26px] lg:pr-1 w-[312px]  h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.67px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-center items-center md:gap-[113.44px] lg:gap-[198px]  gap-[66px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.67px] bg-white md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] justify-end items-center inline-flex">
    <div class="self-stretch justify-center items-center lg:gap-[198px] gap-[66px] md:gap-[113.44px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.66px] bg-white justify-end md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px]  items-center inline-flex">
    <div class="self-stretch justify-center items-center lg:gap-[198px] gap-[66px]  md:gap-[113.44px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px]  pt-3 pb-[11.66px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-center items-center lg:gap-[198px] gap-[66px] md:gap-[113.44px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px]  pt-[7px] pb-[6.66px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-center items-center lg:gap-[198px] gap-[66px] md:gap-[113.44px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] justify-end items-center lg:gap-[198px] md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] gap-[66px] inline-flex">
<div class="self-stretch justify-center items-center lg:gap-[198px] gap-[66px] md:gap-[113.44px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] pt-3 pb-[11.67px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-center items-center lg:gap-[198px] gap-[66px] md:gap-[113.44px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-[7px] md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] pb-[6.67px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-center items-center lg:gap-[198px] gap-[66px] md:gap-[113.44px]  inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] justify-end items-center md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] gap-[66px] inline-flex">
<div class="self-stretch justify-center items-center lg:gap-[198px] gap-[66px] md:gap-[113.44px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] pb-[11.67px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-center items-center  lg:gap-[198px] gap-[66px] md:gap-[113.44px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-[7px] pb-[6.67px] bg-white md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] justify-end items-center inline-flex">
    <div class="self-stretch justify-center items-center lg:gap-[198px] gap-[66px] md:gap-[113.44px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] justify-end items-center gap-[66px] md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] inline-flex">
<div class="self-stretch justify-center items-center lg:gap-[198px] gap-[66px] md:gap-[113.44px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.66px] bg-white md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] justify-end items-center inline-flex">
    <div class="self-stretch justify-center items-center lg:gap-[198px] gap-[66px] md:gap-[113.44px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-[7px] pb-[6.66px] bg-white justify-end md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] items-center inline-flex">
    <div class="self-stretch justify-center items-center lg:gap-[198px] gap-[66px] md:gap-[113.44px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-[7px] pb-[6.67px] bg-white justify-end md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] items-center inline-flex">
    <div class="self-stretch justify-center items-center lg:gap-[198px] gap-[66px] md:gap-[113.44px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.67px] bg-white justify-end md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] items-center inline-flex">
    <div class="self-stretch justify-center items-center lg:gap-[198px] gap-[66px] md:gap-[113.44px] inline-flex">
...
<div class="lg:w-[936px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[7px] pr-[3px] pt-[7.02px] pb-[6.64px] bg-white justify-end md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] items-center inline-flex">
    <div class="self-stretch justify-center items-center lg:gap-[198px] gap-[66px] md:gap-[113.44px] inline-flex">
...
{isOpen4 && (
<div className="flex lg:ml-[150px] lg:justify-around md:mt-[480px]  lg:mt-[750px] mt-[390px] absolute flex-col">
<div class="lg:w-full md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px]  lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.67px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-start items-start md:gap-[113.44px] lg:gap-[198px] gap-[66px] inline-flex">
        <div class="lg:w-[169px] lg:text-base md:w-[96.82px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[8px] font-medium leading-[10.40px]">WAEC PIN</div>
        <div class="lg:w-40 lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium leading-[10.40px]">100</div>
        <div class="lg:w-[181px] lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[60.33px] text-black text-[8px] font-medium leading-[10.40px]">(₦10,000.00)</div>
    </div>
</div>
<div class="lg:w-full md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.66px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-start items-start md:gap-[113.44px] gap-[66px] lg:gap-[198px] inline-flex">
        <div class="lg:w-[169px] lg:text-base md:w-[96.82px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[8px] font-medium leading-[10.40px]">NECO PIN</div>
        <div class="lg:w-40 lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium leading-[10.40px]">100</div>
        <div class="lg:w-[181px] lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[60.33px] text-black text-[8px] font-medium leading-[10.40px]">(₦10,000.00)</div>
    </div>
</div>
<div class="lg:w-full md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.67px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-start items-start md:gap-[113.44px] lg:gap-[198px] gap-[66px] inline-flex">
        <div class="lg:w-[169px] lg:text-base md:w-[96.82px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[8px] font-medium  leading-[10.40px]">JAMB PIN</div>
        <div class="lg:w-40 lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium  leading-[10.40px]">100</div>
        <div class="lg:w-[181px] lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[60.33px] text-black text-[8px] font-medium  leading-[10.40px]">(₦10,000.00)</div>
    </div>
</div>
<div class="lg:w-full md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.67px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-start items-start md:gap-[113.44px] lg:gap-[198px] gap-[66px] inline-flex">
        <div class="lg:w-[169px] lg:text-base md:w-[96.82px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[8px] font-medium  leading-[10.40px]">NABTEB PIN</div>
        <div class="lg:w-40 lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium  leading-[10.40px]">100</div>
        <div class="lg:w-[181px] lg:text-base lg:leading-tight md:w-[91.67px]  md:text-[9.17px] md:leading-3 w-[60.33px] text-black text-[8px] font-medium  leading-[10.40px]">(₦10,000.00)</div>
    </div>
</div>
<div class="lg:w-full md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-2 pb-[7.66px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-start items-start lg:gap-[198px] md:gap-[113.44px] gap-[66px] inline-flex">
        <div class="lg:w-[169px] lg:text-base md:w-[96.82px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[7px] font-medium  leading-[9.10px]">GOTV SUBSCRIPTION</div>
        <div class="lg:w-40 lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium  leading-[10.40px]">100</div>
        <div class="lg:w-[181px] lg:text-base lg:leading-tight md:w-[91.67px]  md:text-[9.17px] md:leading-3 w-[60.33px] text-black text-[8px] font-medium  leading-[10.40px]">(₦10,000.00)</div>
    </div>
</div>
<div class="lg:w-full md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-2 pb-[7.67px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-start items-start lg:gap-[198px] md:gap-[113.44px] gap-[66px] inline-flex">
        <div class="lg:w-[169px] lg:text-base md:w-[96.82px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[7px] font-medium leading-[9.10px]">DSTV SUBSCRIPTION</div>
        <div class="lg:w-40 lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium leading-[10.40px]">100</div>
        <div class="lg:w-[181px] lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[60.33px] text-black text-[8px] font-medium leading-[10.40px]">(₦10,000.00)</div>
    </div>
</div>
<div class="lg:w-full md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-2 pb-[7.67px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-start items-start lg:gap-[198px] md:gap-[113.44px] gap-[66px] inline-flex">
        <div class="lg:w-[169px] lg:text-base md:w-[96.82px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[7px] font-medium  leading-[9.10px]">STARTIME SUBSCRIPTION</div>
        <div class="lg:w-40 lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium  leading-[10.40px]">100</div>
        <div class="lg:w-[181px] lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[60.33px] text-black text-[8px] font-medium  leading-[10.40px]">(₦10,000.00)</div>
    </div>
</div>
<div class="lg:w-full md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] lg:h-[101px] lg:pl-[26px] lg:pr-1  w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-2 pb-[7.67px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-start items-start lg:gap-[198px] gap-[66px] md:gap-[113.44px] inline-flex">
        <div class="lg:w-[169px] lg:text-base lg:leading-tight md:w-[96.82px]  md:text-[9.17px] md:leading-3 w-[56.33px] text-black text-[7px] font-medium leading-[9.10px]">SHOWMAX SUBSCRIPTION</div>
        <div class="lg:w-40 lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium leading-[10.40px]">100</div>
        <div class="lg:w-[181px] lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[60.33px] text-black text-[8px] font-medium leading-[10.40px]">(₦10,000.00)</div>
    </div>
</div>
<div class="lg:w-full md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] lg:h-[101px] lg:pl-[26px] lg:pr-1  w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-[7px] pb-[6.67px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-start items-start lg:gap-[198px] md:gap-[113.44px]  gap-[66px] inline-flex">
        <div class="lg:w-[169px] lg:text-base md:w-[96.82px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[8px] font-medium leading-[10.40px]">ELECTRICITY BILLS</div>
        <div class="lg:w-40 lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium leading-[10.40px]">100</div>
        <div class="lg:w-[181px] lg:text-base lg:leading-tight md:w-[91.67px]  md:text-[9.17px] md:leading-3 w-[60.33px] text-black text-[8px] font-medium leading-[10.40px]">(₦10,000.00)</div>
    </div>
</div>
<div class="lg:w-full md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] lg:h-[101px] lg:pl-[26px] lg:pr-1  w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-3 pb-[11.66px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-start items-start gap-[66px] md:gap-[113.44px] lg:gap-[198px] inline-flex">
        <div class="lg:w-[169px] lg:text-base md:w-[96.82px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[56.33px] text-black text-[8px] font-medium leading-[10.40px]">BULK SMS</div>
        <div class="lg:w-40 lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium leading-[10.40px]">100</div>
        <div class="lg:w-[181px] lg:text-base lg:leading-tight md:w-[91.67px]  md:text-[9.17px] md:leading-3 w-[60.33px] text-black text-[8px] font-medium leading-[10.40px]">(₦10,000.00)</div>
    </div>
</div>
<div class="lg:w-full md:w-[536.25px] md:h-[57.86px] md:pl-[14.90px] md:pr-[2.29px] lg:h-[101px] lg:pl-[26px] lg:pr-1 w-[312px] h-[33.67px] pl-[8.67px] pr-[1.33px] pt-2 pb-[7.67px] bg-white justify-end items-center inline-flex">
    <div class="self-stretch justify-start items-start lg:gap-[198px] md:gap-[113.44px] gap-[66px] inline-flex">
        <div class="lg:w-[169px] lg:text-base lg:leading-tight md:w-[96.82px]  md:text-[9.17px] md:leading-3 w-[56.33px] text-black text-[7px] font-medium leading-[9.10px]">RECHARGE CARD PRINTING</div>
        <div class="lg:w-40 lg:text-base md:w-[91.67px]  md:text-[9.17px] md:leading-3 lg:leading-tight w-[53.33px] text-black text-[8px] font-medium leading-[10.40px]">100</div>
        <div class="lg:w-[181px] lg:text-base lg:leading-tight md:w-[91.67px]  md:text-[9.17px] md:leading-3 w-[60.33px] text-black text-[8px] font-medium leading-[10.40px]">(₦10,000.00)</div>
    </div>
</div>
<div class="lg:w-[187px] lg:h-[52px] lg:py-4 md:ml-[200px] lg:gap-[26px] md:w-[108.08px] md:h-[30.06px] md:py-[9.17px] md:gap-[14.90px]  mt-[20px] w-[134.08px] h-[15.73px] lg:ml-[350px] justify-center ml-[90px] items-center gap-[14.90px] inline-flex">
