        ...
        <section className={`${isDarkMode ? "bg-[#000]" : "bg-[#ffffff]"}`}>
          ...
          <div className="mt-[30px]">
            ...
            <div className="relative mt-[5px] lg:mt-[15px]">
              <input
                type="number"
                className={`w-full md:w-1/2 lg:w-[40%] h-8 px-2 py-[20px] border-[1px] rounded-md text-[12px] md:text-[14px] lg:text-[18px] font-semibold focus:outline-none lg:h-[51px] ${
        ...
        {update && (
          <Modal>
            <div
              ...
              } md:mx-auto md:my-auto lg:mx-auto lg:my-auto rounded-[12px] ${
            ...
            >
              ...
              <p className={`md:mt-[15%] lg:mt-[10%] text-[12px] px-[20px] md:text-[14px] lg:text-[18px] font-extrabold text-center my-[4%] lg:my-[5%] ${isDarkMode ? "text-white" :""}`}>
