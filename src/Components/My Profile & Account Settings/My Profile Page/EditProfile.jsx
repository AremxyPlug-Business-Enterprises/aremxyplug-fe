...
gap-2.5 lg:gap-[10px] cursor-default lg:mb-[26px] md:mb-[15.26px] mb-[20px]"
     ...
     lg:text-[16px] lg:leading-[20.8px] ${isDarkMode ? "text-white" : ""}`}
                  ...
                  >
                    <button
                      className="w-[100%] text-[12px] leading-[18px]
...
gap-2.5 lg:gap-[10px] cursor-default"
     ...
     lg:text-[16px] lg:leading-[20.8px] cursor-default"
                  ...
                  >
                    <button
                      className="w-[100%] text-[12px] leading-[18px] md:text-[9.389px]  md:leading-[14px]
   md:rounded-[12px] rounded-[4.241px] 
       font-[600] lg:text-[16px] lg:leading-[24px]
     ...
     justify-center px-[8.594px]  lg:pt-[20%] lg:pb-[20%] md:pt-[100%] md:pb-[30%] pt-[40%] pb-[30%]"
          >
            <p
              ...
              leading-[10.4px] lg:text-[16px] lg:leading-[15.6px] md:leading-[12.938px] self-center ${isDarkMode ? "text-white" : "text-black"}`}
            >
              You need help?
            </p>
            <Link
              to="/contactUs"
              className="font-[500] text-white text-[12px]  py-[8px] px-[10.594px] leading-[10.4px] rounded-[5.156px] bg-[#04177F] lg:text-[12px] lg:leading-[14.4px] md:py-[4.865px] md:px-[14.594px] md:leading-[5.985px] lg:py-[10px] lg:px-[16px] lg:rounded-[9px]"
            >
              Contact Us
            </Link>
          </div>
