...
export default function ProfileHero() {
  return (
    <div className="ProfileHero items-center w-[100%] rectangle1 flex justify-between gap-[8.34px] min-h-[88.53px] pt-[9px] pr-[4.619px] pb-[8.824px] pl-[16.72px]  mb-[20px] rounded-[6.667px] md:pt-[11.737px] md:pb-[6.454px] md:pr-[9.861px] md:pl-[29.339px] md:gap-[17.604px] md:h-[112.02px] md:rounded-[11.736px] lg:py-[20px] lg:pl-[60px] lg:pr-[15px] lg:gap-[20px] lg:h-[200px]
     lg:rounded-[20px]"> 
       <div className="flex flex-col gap-[5.016px]  w-[70%] lg:gap-[15px] md:gap-[8.802px]">
           {/* header */}
           <h2
             className={`font-[600] leading-[12px] text-[12px] text-[#000] md:text-[14.75px] md:leading-[22px]
