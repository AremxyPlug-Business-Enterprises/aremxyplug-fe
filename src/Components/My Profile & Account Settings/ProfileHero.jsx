...
export default function ProfileHero() {
  return (
    <div className="ProfileHero items-center w-[100%] rectangle1 flex justify-between gap-[8.34px] min-h-[88.53px] pt-[9px]   pr-[4.619px] pb-[8.824px] pl-[16.72px]  mb-[20px] rounded-[6.667px] md:pt-[11.737px] md:pb-[6.454px] md:pr-[9.861px] md:pl-[29.339px] md:gap-[17.604px] md:h-[112.02px]
