    ...
    <DashBoardLayout>
      <div className="">
        <div className="">
          <ProfileHero />
          <div
            className="flex flex-wrap md:flex-nowrap  mt-[23px] md:w-[100%]  
        ...
        justify-between "
          ...
          md:border-none border-b-[1.7px] border-[#D9D9D999] border-opacity-[60%]"
            >
              <h2
                className=" font-[600] text-[#A3A3A3] py-[8px] text-start pl-[10px]
         text-[9.389px] lg:p-[10px] leading-[14px] lg:text-[16px] lg:leading-[24px]"
              ...
              {profilePage && (
                <div
                  className="flex w-[100%] md:w-[60%]
                    md:h-[3px] h-[2px] rounded-[10px]  bg-[#04177F]"
                ></div>
              )}
            </div>
            ...
            >
              ...
              {authenticationOpen && (
                <div
                  className="flex w-[100%] md:w-[70%]  md:h-[3px] h-[2px] rounded-[10px]
                      bg-[#04177F]"
                ></div>
              )}
            </div>
