...
{verificationFailed && (
  <Modal>
    <div className="confirm2 relative md:w-[55%] w-[90%] flex flex-col justify-between md:mb-[0%] md:mx-auto md:my-auto lg:mx-auto lg:my-auto">
      <div className="relative z-10">
        <p className="text-[10px] px-[20px] md:text-[16px] lg:text-[18px] font-semibold text-center mt-[4%] lg:my-[%] z-[1000]">
          Verification Failed
        </p>
        <p className="text-[10px] px-[20px] md:text-[16px] lg:text-[18px] font-semibold text-center mt-[4%] lg:my-[%] z-[1000]">
          Your BVN verification was not successful. Please try again.
        </p>
      </div>
      <div>
        <img src={Delete} alt="" />
